...
namespace YMS_gantry.UI
{
    public partial class FrmCreateBraceAndJoint : Form
    {
        ...
        private void InitializeBindings()
        {
            ...
            CmbKoudaiName.DataBindings.Add(nameof(ComboBox.DataSource), vm, nameof(VMType.KodaiSet), true, DataSourceUpdateMode.OnPropertyChanged);
            CmbKoudaiName.DisplayMember = nameof(AllKoudaiFlatFrmData.KoudaiName);
            CmbKoudaiName.DataBindings.Add(nameof(ComboBox.SelectedValue), vm, nameof(VMType.SelectedKodai), true, DataSourceUpdateMode.OnPropertyChanged);

            ChkHasVerBraceKyoujiku.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.VrtBraceHasK), true, DataSourceUpdateMode.OnPropertyChanged);
            ChkHasVerBraceHukuin.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.VrtBraceHasH), true, DataSourceUpdateMode.OnPropertyChanged);

            CmbVerBraceSize.DataBindings.Add(nameof(ComboBox.DataSource), vm, nameof(VMType.VrtBraceSizeList), true, DataSourceUpdateMode.OnPropertyChanged);
            CmbVerBraceSize.DisplayMember = nameof(ClsMasterCsv.Size);
            CmbVerBraceSize.DataBindings.Add(nameof(ComboBox.SelectedValue), vm, nameof(VMType.VrtBraceSize), true, DataSourceUpdateMode.OnPropertyChanged);
            // SelectedValueへの値変更では反映できないのでSelectedIndexを追加
            CmbVerBraceSize.DataBindings.Add(nameof(ComboBox.SelectedIndex), vm, nameof(VMType.VrtBraceSizeIndex), true, DataSourceUpdateMode.OnPropertyChanged);

            radioButton8.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.VrtBracePriorH), true, DataSourceUpdateMode.OnPropertyChanged);
            radioButton9.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.VrtBracePriorK), true, DataSourceUpdateMode.OnPropertyChanged);

            numericUpDown2.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace1UpperXMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown4.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace1UpperYMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown6.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace1LowerXMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown5.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace1LowerYMm), true, DataSourceUpdateMode.OnPropertyChanged);

            numericUpDown12.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace2UpperXMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown11.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace2UpperYMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown10.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace2LowerXMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown9.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.VrtBrace2LowerYMm), true, DataSourceUpdateMode.OnPropertyChanged);
            ...
            checkBox3.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.VrtBraceHasRound), true, DataSourceUpdateMode.OnPropertyChanged);
            comboBox4.DataBindings.Add(nameof(ComboBox.Enabled), vm, nameof(VMType.VrtBraceHasRound), true, DataSourceUpdateMode.OnPropertyChanged);
            comboBox4.DataBindings.Add(nameof(YMS_gantry.UI.YmsComboInteger._Number), vm, nameof(VMType.VrtBraceRoundMm), true, DataSourceUpdateMode.OnPropertyChanged);

            RbtVerBraceWelding.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.VrtBraceIsWelding), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtVerBraceBolt.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.VrtBraceIsBolt), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtVerBraceSup.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.VrtBraceIsMetal), true, DataSourceUpdateMode.OnPropertyChanged);

            radioButton12.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceHasPlacing), true, DataSourceUpdateMode.OnPropertyChanged);
            radioButton13.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceHasNotPlacing), true, DataSourceUpdateMode.OnPropertyChanged);

            comboBox2.DataBindings.Add(nameof(ComboBox.DataSource), vm, nameof(VMType.HrzBraceSizeList), true, DataSourceUpdateMode.OnPropertyChanged);
            comboBox2.DisplayMember = nameof(ClsAngleCsv.Size);
            comboBox2.DataBindings.Add(nameof(ComboBox.SelectedValue), vm, nameof(VMType.HrzBraceSize), true, DataSourceUpdateMode.OnPropertyChanged);
            // SelectedValueへの値変更では反映できないのでSelectedIndexを追加
            comboBox2.DataBindings.Add(nameof(ComboBox.SelectedIndex), vm, nameof(VMType.HrzBraceSizeIndex), true, DataSourceUpdateMode.OnPropertyChanged);

            radioButton10.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceIsOhbikiInner), true, DataSourceUpdateMode.OnPropertyChanged);
            radioButton11.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceIsLowerOhbiki), true, DataSourceUpdateMode.OnPropertyChanged);

            checkBox13.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.HrzBraceHasTopPlate), true, DataSourceUpdateMode.OnPropertyChanged);

            numericUpDown16.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzBraceXMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown15.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzBraceYMm), true, DataSourceUpdateMode.OnPropertyChanged);

            RbtHorBraceWelding.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceIsWelding), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtHorBraceBolt.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceIsBolt), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtHolBraceSup.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzBraceIsMetal), true, DataSourceUpdateMode.OnPropertyChanged);

            checkBox2.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.HrzJointHasK), true, DataSourceUpdateMode.OnPropertyChanged);
            checkBox1.DataBindings.Add(nameof(CheckBox.Checked), vm, nameof(VMType.HrzJointHasH), true, DataSourceUpdateMode.OnPropertyChanged);

            comboBox5.DataBindings.Add(nameof(ComboBox.DataSource), vm, nameof(VMType.HrzJointSizeList), true, DataSourceUpdateMode.OnPropertyChanged);
            comboBox5.DisplayMember = nameof(ClsChannelCsv.Size);
            comboBox5.DataBindings.Add(nameof(ComboBox.SelectedValue), vm, nameof(VMType.HrzJointSize), true, DataSourceUpdateMode.OnPropertyChanged);
            // SelectedValueへの値変更では反映できないのでSelectedIndexを追加
            comboBox5.DataBindings.Add(nameof(ComboBox.SelectedIndex), vm, nameof(VMType.HrzJointSizeIndex), true, DataSourceUpdateMode.OnPropertyChanged);

            radioButton7.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointUpperIsH), true, DataSourceUpdateMode.OnPropertyChanged);
            radioButton4.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointLowerIsH), true, DataSourceUpdateMode.OnPropertyChanged);

            numericUpDown7.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzJointStartMm), true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDown8.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzJointEndMm), true, DataSourceUpdateMode.OnPropertyChanged);

            RbtHorJointWelding.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsWelding), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtHorJointBolt.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsBolt), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtHorJointSup.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsMetal), true, DataSourceUpdateMode.OnPropertyChanged);

            NmcHolJointDan.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.DanCount), true, DataSourceUpdateMode.OnPropertyChanged);
            NmcHolJointDist.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.DanBaseInterval), true, DataSourceUpdateMode.OnPropertyChanged);
            ...
            DgvDansu.DataBindings.Add(nameof(DataGridView.DataSource), vm, nameof(VMType.DanRowSet), true, DataSourceUpdateMode.OnPropertyChanged);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var displayJointRecords = jointRecords.Where(x => x is ClsHBeamCsv)
                .Concat(jointRecords.Where(x => x is ClsChannelCsv))
                .Concat(jointRecords.Where(x => x is ClsAngleCsv));
        ...
        private void LoadExtensionData()
        {
            ...
            {
                ViewModel.VrtBraceSize = ViewModel.VrtBraceSizeList.First(x => x.Size == data.BraceTsunagiData.VerticalBrace.Size);
            ...
            if (int.TryParse(data.BraceTsunagiData.VerticalBrace.RoundLength, out tmpInt)) ViewModel.VrtBraceRoundMm = tmpInt;
            ...
            {
                ViewModel.HrzBraceSize = ViewModel.HrzBraceSizeList.First(x => x.Size == data.BraceTsunagiData.HorizontalBrace.Size);
            ...
            {
                ViewModel.HrzJointSize = ViewModel.HrzJointSizeList.First(x => x.Size == data.BraceTsunagiData.HorizontalTsunagi.Size);
        ...
        private void LoadCalcFileData()
        {
            ...
            {
                ViewModel.VrtBraceSize = ViewModel.VrtBraceSizeList.FirstOrDefault(x => x.Size == data.CalcFileData.VBrace.Size);
                ViewModel.VrtBraceSizeIndex = ViewModel.VrtBraceSizeList.IndexOf(ViewModel.VrtBraceSize);
            }
            ...
            {
                ViewModel.HrzBraceSize = ViewModel.HrzBraceSizeList.FirstOrDefault(x => x.Size == data.CalcFileData.HBrace.Size);
                ViewModel.HrzBraceSizeIndex = ViewModel.HrzBraceSizeList.IndexOf(ViewModel.HrzBraceSize);
            }
            ...
            {
                ViewModel.HrzJointSize = ViewModel.HrzJointSizeList.FirstOrDefault(x => data.CalcFileData.JointMember.Size.Contains(x.Size));
                ViewModel.HrzJointSizeIndex = ViewModel.HrzJointSizeList.IndexOf(ViewModel.HrzJointSize);
            }
