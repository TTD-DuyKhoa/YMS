...
namespace YMS_gantry.UI
{
    public partial class FrmPutOhbikiKetauke : System.Windows.Forms.Form
    {
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            bool  isHkou = !string.IsNullOrEmpty(this.CmbSizeType.Text) && (!this.CmbSizeType.SelectedItem.ToString().Equals("チャンネル") &&
                ...
                if (kdata.KoujiType == DefineUtil.eKoujiType.Kenchiku)
                {
                    ...
                    lstStr = new List<string>() {Master.ClsHBeamCsv.TypeHiro,
                                                 ...
                                                 Master.ClsHBeamCsv.TypeHoso,
                                                  Master.ClsYamadomeCsv.TypeShuzai,Master.ClsYamadomeCsv.TypeHighShuzai};
                }
                else
                {
                    this.Text = "[個別] 桁受配置";
                    ...
                    if (!kdata.ohbikiData.isHkou)
                    {
                        ...
                        this.RbtOhbikiWeld.Checked = kdata.ohbikiData.OhbikiAttachType == DefineUtil.eJoinType.Welding ? true : false;

                        this.RbtOhbikiNormalB.Checked = kdata.ohbikiData.OhbikiBoltType == DefineUtil.eBoltType.Normal ? true : false;
