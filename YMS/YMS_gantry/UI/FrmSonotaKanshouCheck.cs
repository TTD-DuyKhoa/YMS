    ...
    private void BtnKanshouCheck_Click( object sender, EventArgs e )
    {
      try {
        ...
        foreach ( var rowData in rowDataList ) {
          this.DgvKanshouCheckList.Rows.Add( new object[]
          {
            rowData.Id, false, rowData.KoudaiName, rowData.DaiBunrui, rowData.ChuuBunrui, rowData.ShouBunrui,
            rowData.FamilyName
          } ) ;
        }
      ...
      foreach ( var elementId in resultList ) {
        ...
        if ( material == null ) {
          ...
          if ( ! isYmsParam ) {
            ...
            var lineString =
              ClsRevitUtil.GetInstMojiParameter( _uiDoc.Document, elementId, DefineUtil.PARAM_MATERIAL_DETAIL ) ;
