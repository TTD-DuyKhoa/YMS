...
namespace YMS_gantry.UI
{
  public partial class FrmPutHorizontalBrace : System.Windows.Forms.Form
  {
    ...
    private void button1_Click( object sender, EventArgs e )
    {
      ...
      fData.SetObikiFace = ( RbtPutLocationOhbikiTopFlBottom.Checked
        ? FrmPutHorizontalBraceData.SetFace.UpperB
        : ( RbtPutLocationOhbikiBottomFlTop.Checked
          ? FrmPutHorizontalBraceData.SetFace.LowerT
      ...
      fData.VrtBraceConnectingType = ( RbtAttachWayWelding.Checked
        ? FrmPutHorizontalBraceData.ConnectingType.Welding
        : ( RbtAttachWayBolt.Checked
          ? FrmPutHorizontalBraceData.ConnectingType.Bolt
    ...
    public void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, RbtPutLocationOhbikiTopFlBottom.Name,
        RbtPutLocationOhbikiTopFlBottom.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, RbtPutLocationOhbikiBottomFlTop.Name,
        RbtPutLocationOhbikiBottomFlTop.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, RbtPutLocationOhbikiBottomFlBottom.Name,
        RbtPutLocationOhbikiBottomFlBottom.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, RbtPutLocationOnTopPL.Name, RbtPutLocationOnTopPL.Checked.ToString(),
        iniPath ) ;
    ...
    public void GetIniData()
    {
      ...
      if ( File.Exists( iniPath ) ) {
        ...
        RbtPutLocationOhbikiTopFlBottom.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, RbtPutLocationOhbikiTopFlBottom.Name, iniPath ) ) ;
        RbtPutLocationOhbikiBottomFlTop.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, RbtPutLocationOhbikiBottomFlTop.Name, iniPath ) ) ;
        RbtPutLocationOhbikiBottomFlBottom.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, RbtPutLocationOhbikiBottomFlBottom.Name, iniPath ) ) ;
    ...
    private void button2_Click( object sender, EventArgs e )
    {
      ...
      if ( koudaiData == null || koudaiData.BraceTsunagiData == null ||
           koudaiData.BraceTsunagiData.HorizontalBrace == null ) {
