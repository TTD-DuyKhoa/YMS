...
{
  public class ClsTurnBackleCsv : ClsMasterCsv
  {
    #region メンバ変数
    ...
    /// CSV名称
    /// </summary>
    private const string CsvFileName = "TurnBackle.csv" ;

    /// <summary>
    /// メンバ変数
    /// </summary>
    private static List<ClsTurnBackleCsv> m_Data = new List<ClsTurnBackleCsv>() ;

    /// <summary>
    /// マスタ名称
    /// </summary>
    public const string MasterName = "ターンバックル" ;

    /// <summary>
    /// 種類
    /// </summary>
    public const string TurnBackle = "ターンバックル" ;
    ...
    public static bool GetCsv()
    {
      ...
      bool bHeader = true ;
      List<ClsTurnBackleCsv> lstCls = new List<ClsTurnBackleCsv>() ;
      foreach ( List<string> lstStr in lstlstStr ) {
        ...
        var index = 0 ;
        ClsTurnBackleCsv cls = new ClsTurnBackleCsv
        {
          Type = lstStr[ index++ ], Size = lstStr[ index++ ], FamilyPath = lstStr[ index++ ],
        } ;
        lstCls.Add( cls ) ;
      }
    ...
    /// <returns></returns>
    [YmsMasterLoad]
    public static List<ClsTurnBackleCsv> GetCsvData()
    {
      GetCsv() ;
      return m_Data ;
    }
