...
namespace YMS_gantry.Material
{
  ...
  public sealed class FukkouGeta : MaterialSuper
  {
    ...
    public FukkouGeta( ElementId id, string koudaiName, string material, string size ) : base( id, koudaiName, material,
      size )
    {
    }

    public static ElementId CreateOnFace( Document doc, FukkouGeta fg, XYZ point1, XYZ point2, Reference refer,
      double rotate, string koudainame )
    {
      ...
      //高さ
      RevitUtil.ClsRevitUtil.SetParameter( doc, id, DefineUtil.PARAM_HOST_OFFSET,
