...
namespace YMS.Command
{
  internal class ClsCommandAtamaTsunagi
  {
    ...
    public static void CommandCreateAtamaTsunagiHojoZai( UIDocument uidoc )
    {
      ...
      clsAtamaTsunagi.CreateAtamaTsunagiHojoZai( doc, oyakuiId, atamatsunagiId,
        dlgCreateAtamatsunagiHojo.m_IsAoutoLayout, dlgCreateAtamatsunagiHojo.m_BracketInterval,
        dlgCreateAtamatsunagiHojo.m_IsSide ) ;
    }
