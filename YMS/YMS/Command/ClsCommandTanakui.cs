                ...
                try
                {
                    ...
                    foreach (XYZ point in uniqueInsertPoints)
                    {
                        ...
                        if (dlgCreateTanakui.m_ClsKui.m_CreateKiribariBracket)
                        {
                            ...
                            if (clsBracket.CreateKiribariBracket(doc, clsKui.m_CreateId, dlgCreateTanakui.m_ClsKui.m_KiribariBracketSizeIsAuto))
                            {
                                // プレロードガイド材も作成する場合
                        ...
                        if (dlgCreateTanakui.m_ClsKui.m_CreateKiribariOsaeBracket)
                        {
                            ...
                            clsBracket.m_TargetKuiCreatePosition = dlgCreateTanakui.m_ClsKui.m_CreatePosition;
                            clsBracket.m_TargetKuiCreateType = dlgCreateTanakui.m_ClsKui.m_CreateType;
                            if (clsBracket.CreateKiribariOsaeBracket(doc, clsKui.m_CreateId, dlgCreateTanakui.m_ClsKui.m_KiribariOsaeBracketSizeIsAuto))
                            {
                                // ガイド材も作成する場合
        ...
        public static void CommandChangeTanakui(UIDocument uidoc)
        {
            ...
            for (int i = 0; i < ids.Count(); i++)
            {
                ...
                else
                {
                    ...
                    tmp.m_CreateKiribariBracket = ClsRevitUtil.CompareValues(trgKui.m_CreateKiribariBracket, tmp.m_CreateKiribariBracket);
                    tmp.m_CreatePreloadGuide = ClsRevitUtil.CompareValues(trgKui.m_CreatePreloadGuide, tmp.m_CreatePreloadGuide);
                    tmp.m_CreateKiribariOsaeBracket = ClsRevitUtil.CompareValues(trgKui.m_CreateKiribariOsaeBracket, tmp.m_CreateKiribariOsaeBracket);
                    ...
                    tmp.m_TsugitePlateSize_Out = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateSize_Out, tmp.m_TsugitePlateSize_Out);
                    tmp.m_TsugitePlateQuantity_Out = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateQuantity_Out, tmp.m_TsugitePlateQuantity_Out);
                    tmp.m_TsugitePlateSize_In = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateSize_In, tmp.m_TsugitePlateSize_In);
                    tmp.m_TsugitePlateQuantity_In = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateQuantity_In, tmp.m_TsugitePlateQuantity_In);
                    tmp.m_TsugitePlateSize_Web1 = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateSize_Web1, tmp.m_TsugitePlateSize_Web1);
                    tmp.m_TsugitePlateQuantity_Web1 = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateQuantity_Web1, tmp.m_TsugitePlateQuantity_Web1);
                    tmp.m_TsugitePlateSize_Web2 = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateSize_Web2, tmp.m_TsugitePlateSize_Web2);
                    tmp.m_TsugitePlateQuantity_Web2 = ClsRevitUtil.CompareValues(trgKui.m_TsugitePlateQuantity_Web2, tmp.m_TsugitePlateQuantity_Web2);
                    tmp.m_TsugiteBoltSize_Flange = ClsRevitUtil.CompareValues(trgKui.m_TsugiteBoltSize_Flange, tmp.m_TsugiteBoltSize_Flange);
                    tmp.m_TsugiteBoltQuantity_Flange = ClsRevitUtil.CompareValues(trgKui.m_TsugiteBoltQuantity_Flange, tmp.m_TsugiteBoltQuantity_Flange);
                    tmp.m_TsugiteBoltSize_Web = ClsRevitUtil.CompareValues(trgKui.m_TsugiteBoltSize_Web, tmp.m_TsugiteBoltSize_Web);
                    tmp.m_TsugiteBoltQuantity_Web = ClsRevitUtil.CompareValues(trgKui.m_TsugiteBoltQuantity_Web, tmp.m_TsugiteBoltQuantity_Web);
                }
            }
