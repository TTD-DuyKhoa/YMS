            ...
            for (; ; )
            {
                ...
                try
                {
                    if (clsHTB.m_ShoriType == ClsHiuchiTsunagizaiBase.ShoriType.Replace)
                    {
                        ...
                        if (!ClsRevitUtil.PickObjectFilters(uidoc, "レベルを合わせる火打ベース", ClsGlobal.m_baseHiuchiList, ref idHiuchi))
                        {
                            return;
                        }
                    ...
                    else
                    {
                        ...
                        if (!ClsRevitUtil.PickObjectFilters(uidoc, "火打ベース1本目を指定してください", ClsGlobal.m_baseHiuchiList, ref idHiuchi1))
                        {
                            return;
                        }
                        ...
                        if (!ClsRevitUtil.PickObjectFilters(uidoc, "火打ベース2本目を指定してください", ClsGlobal.m_baseHiuchiList, ref idHiuchi2))
                        {
                            return;
                        }
                        ...
                        if (!ClsRevitUtil.PickObjectElementFilter(uidoc, selMess + "火打ベース上で配置点を指定してください", filterList, ref rfPick))
                        {
                            return;
                        }
