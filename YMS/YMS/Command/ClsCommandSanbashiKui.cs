    ...
    public static void CommandChangeKui( UIDocument uidoc )
    {
      ...
      for ( int i = 0 ; i < ids.Count() ; i++ ) {
        ...
        if ( i == 0 ) {
          ...
          template.m_KouzaiSizeKoudaikui =
            ClsRevitUtil.CompareValues( trgKui.m_KouzaiSizeKoudaikui, template.m_KouzaiSizeKoudaikui ) ;
          template.m_KouzaiSizeDanmenHenkaKui = ClsRevitUtil.CompareValues( trgKui.m_KouzaiSizeDanmenHenkaKui,
            template.m_KouzaiSizeDanmenHenkaKui ) ;
          template.m_PileTotalLength =
            ClsRevitUtil.CompareValues( trgKui.m_PileTotalLength, template.m_PileTotalLength ) ;
          template.m_PileTotalLength_Top =
            ClsRevitUtil.CompareValues( trgKui.m_PileTotalLength_Top, template.m_PileTotalLength_Top ) ;
          template.m_PileTotalLength_Bottom =
            ClsRevitUtil.CompareValues( trgKui.m_PileTotalLength_Bottom, template.m_PileTotalLength_Bottom ) ;
          ...
          template.m_EndPlateThickness =
            ClsRevitUtil.CompareValues( trgKui.m_EndPlateThickness, template.m_EndPlateThickness ) ;
          ...
          template.m_TsugitePlateSize_Out =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Out, template.m_TsugitePlateSize_Out ) ;
          template.m_TsugitePlateSize_Out2 =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Out2, template.m_TsugitePlateSize_Out2 ) ;
          template.m_TsugitePlateQuantity_Out = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Out,
            template.m_TsugitePlateQuantity_Out ) ;
          template.m_TsugitePlateQuantity_Out2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Out2,
            template.m_TsugitePlateQuantity_Out2 ) ;
          template.m_TsugitePlateSize_In =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_In, template.m_TsugitePlateSize_In ) ;
          template.m_TsugitePlateSize_In2 =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_In2, template.m_TsugitePlateSize_In2 ) ;
          template.m_TsugitePlateQuantity_In = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_In,
            template.m_TsugitePlateQuantity_In ) ;
          template.m_TsugitePlateQuantity_In2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_In2,
            template.m_TsugitePlateQuantity_In2 ) ;
          template.m_TsugitePlateSize_Web1 =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Web1, template.m_TsugitePlateSize_Web1 ) ;
          template.m_TsugitePlateSize_Web1_2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Web1_2,
            template.m_TsugitePlateSize_Web1_2 ) ;
          template.m_TsugitePlateQuantity_Web1 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Web1,
            template.m_TsugitePlateQuantity_Web1 ) ;
          template.m_TsugitePlateQuantity_Web1_2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Web1_2,
            template.m_TsugitePlateQuantity_Web1_2 ) ;
          template.m_TsugitePlateSize_Web2 =
            ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Web2, template.m_TsugitePlateSize_Web2 ) ;
          template.m_TsugitePlateSize_Web2_2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateSize_Web2_2,
            template.m_TsugitePlateSize_Web2_2 ) ;
          template.m_TsugitePlateQuantity_Web2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Web2,
            template.m_TsugitePlateQuantity_Web2 ) ;
          template.m_TsugitePlateQuantity_Web2_2 = ClsRevitUtil.CompareValues( trgKui.m_TsugitePlateQuantity_Web2_2,
            template.m_TsugitePlateQuantity_Web2_2 ) ;
          template.m_TsugiteBoltSize_Flange =
            ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltSize_Flange, template.m_TsugiteBoltSize_Flange ) ;
          template.m_TsugiteBoltSize_Flange2 = ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltSize_Flange2,
            template.m_TsugiteBoltSize_Flange2 ) ;
          template.m_TsugiteBoltQuantity_Flange = ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltQuantity_Flange,
            template.m_TsugiteBoltQuantity_Flange ) ;
          template.m_TsugiteBoltQuantity_Flange2 = ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltQuantity_Flange2,
            template.m_TsugiteBoltQuantity_Flange2 ) ;
          template.m_TsugiteBoltSize_Web =
            ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltSize_Web, template.m_TsugiteBoltSize_Web ) ;
          template.m_TsugiteBoltSize_Web2 =
            ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltSize_Web2, template.m_TsugiteBoltSize_Web2 ) ;
          template.m_TsugiteBoltQuantity_Web = ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltQuantity_Web,
            template.m_TsugiteBoltQuantity_Web ) ;
          template.m_TsugiteBoltQuantity_Web2 = ClsRevitUtil.CompareValues( trgKui.m_TsugiteBoltQuantity_Web2,
            template.m_TsugiteBoltQuantity_Web2 ) ;
        }
      }
      ...
      for ( int i = 0 ; i < insertPoints.Count ; i++ ) {
        if ( i == insertPoints.Count - 1 ) {
          ...
          foreach ( XYZ p in insertPoints2 ) {
            if ( ClsGeo.GEO_EQ( insertPoints[ i ].X, p.X, 0.1 ) && ClsGeo.GEO_EQ( insertPoints[ i ].Y, p.Y, 0.1 ) &&
