...
namespace YMS
{
  public class ClsGlobal
  {
    ...
    public static List<string> m_corneryaitasize = new List<string>
    {
      "C3",
      "C4",
      "特殊コーナー",
    ...
    public static List<string> m_syorihouhou5 = new List<string>
    {
      "自動",
      "1辺",
      "2点間",
    ...
    public static List<string> m_tanbubuhin = new List<string>
    {
      "なし",
      "火打ブロック（小）",
      "火打ブロック",
    ...
    public static List<string> m_baseShinList = new List<string>
    {
      ClsHaraokoshiBase.baseName,
      ClsKiribariBase.baseName,
      ClsCornerHiuchiBase.baseName,
      ClsKiribariHiuchiBase.baseName,
      ClsKiribariUkeBase.baseName,
      ClsKiribariTsunagizaiBase.baseName,
      ClsHiuchiTsunagizaiBase.baseName,
      ClsKiribariTsugiBase.baseName,
      ClsSyabariBase.baseName,
      ClsSyabariTsunagizaiBase.baseName,
      ClsSyabariUkeBase.baseName,
      ClsSyabariHiuchiBase.baseName
    } ; //都度ベース芯を追加予定

    public static List<string> m_sanjikuPeaceList =
      new List<string> { "三軸ピース _30SHP", "三軸ピース _35SHP", "三軸ピース _40SHP", "三軸ピース _50SHP-N" } ;
    ...
    public static List<string> m_baseKiriOrKHiuchiOrCHiuchiOrSyabariList =
      new List<string> { "切梁ベース", "切梁火打ベース", "隅火打ベース", "斜梁ベース" } ;

    public static List<string> m_baseAllList = new List<string>
    {
      "切梁ベース",
      "切梁火打ベース",
      "隅火打ベース",
