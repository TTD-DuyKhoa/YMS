...
namespace YMS.Parts
{
  public class ClsHojoPiece
  {
    ...
    public bool CreateHojoPiece( Document doc, ElementId baseId, XYZ ptSt, XYZ ptEd, ElementId levelId, string size,
      string baseName, out double buzaiLength, double baseoffset = 0.0 )
    {
      buzaiLength = 0.0 ;
