...
namespace YMS.Parts
{
  ...
  {
    public static bool CreateKousyabuMawari( Document doc, ElementId levelID, string haraSize, string kiriSize,
      XYZ point, double angle )
    {
      ...
      double offset = ClsRevitUtil.CovertToAPI( Master.ClsYamadomeCsv.GetWidth( kiriSize ) +
                                                ( Master.ClsYamadomeCsv.GetWidth( haraSize ) -
                                                  Master.ClsYamadomeCsv.GetWidth( kiriSize ) ) / 2 ) ;
      if ( symKousya != null ) {
    ...
    public static bool CheckSyuzaiSize( Document doc, XYZ insec, ElementId levelId, out string haraSyuzai,
      string targetDan = "上段" )
    {
