...
namespace YMS.Parts
{
  public class ClsSendanBoltHokyouzai
  {
    ...
    public bool CreateSendanBoltHokyouzai( Document doc, XYZ ptInsert, ElementId levelId, XYZ ptSt, XYZ ptEd,
      double offset, ElementId pieceId, double hokyouzaiHaba )
    {
      // ファミリの取得処理
