      ...
      using ( Transaction t = new Transaction( doc, Guid.NewGuid().GetHashCode().ToString() ) ) {
        try {
          ...
          if ( parameter != null ) {
            ...
            mess = mess + "「" + ClsGlobal.m_zumeninfoSekkeishishin + "」" ;
          }
          ...
          if ( parameter != null ) {
            ...
            mess = mess + "「" + ClsGlobal.m_zumeninfoTokuisaki + "」" ;
          }
          ...
          if ( parameter != null ) {
            ...
            mess = mess + "「" + ClsGlobal.m_zumeninfoGenbaName + "」" ;
          }
          ...
          if ( parameter != null ) {
            ...
            mess = mess + "「" + ClsGlobal.m_zumeninfoSekkeiNum + "」" ;
          }
