...
namespace YMS.Parts
{
  public class ClsYokoyaita
  {
        ...
        using ( Transaction t = new Transaction( doc, Guid.NewGuid().GetHashCode().ToString() ) ) {
          ...
          double oyaSizeHalf =
            ClsRevitUtil.CovertToAPI(
              ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 1 ) ) /
              2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
          //フランジ幅
          double oyaBHalf =
            ClsRevitUtil.CovertToAPI(
              ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 2 ) ) /
              2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
          //腹板厚半分※Point内ずらしと長さ変更
          double oyaT1Half =
            ClsRevitUtil.CovertToAPI(
              ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 3 ) ) /
              2 ) ; //ClsRevitUtil.CovertToAPI(10 / 2);
          //フランジ厚
          double oyaT2 =
            ClsRevitUtil.CovertToAPI(
              ClsCommonUtils.ChangeStrToDbl(
                ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 4 ) ) ) ; //ClsRevitUtil.CovertToAPI(15);
          ...
          oyaPnt1 = new XYZ( oyaPnt1.X + ( oyaBHalf / 2 + oyaT1Half ) * oyaInst1.HandOrientation.X,
            oyaPnt1.Y + ( oyaBHalf / 2 + oyaT1Half ) * oyaInst1.HandOrientation.Y, oyaPnt1.Z ) ;
          ...
          if ( m_putPosFlag == 0 ) {
            ...
            oyaPnt1 = new XYZ( oyaPnt1.X + oyaSizeHalfIn * oyaInst1.FacingOrientation.X,
              oyaPnt1.Y + oyaSizeHalfIn * oyaInst1.FacingOrientation.Y, oyaPnt1.Z ) ;
          }
          else if ( m_putPosFlag == 1 ) {
            //外にずらす
            oyaPnt1 = new XYZ( oyaPnt1.X - oyaSizeHalfOut * oyaInst1.FacingOrientation.X,
              oyaPnt1.Y - oyaSizeHalfOut * oyaInst1.FacingOrientation.Y, oyaPnt1.Z ) ;
          }
    ...
    /// <returns></returns>
    public bool CreateYokoyaita( Document doc, ElementId oyaId1, ElementId oyaId2, double lenght, double kussaku,
      ElementId levelId, double oyaKijyun = 0.0 )
    {
      try {
        string symbolFolpath = ClsZumenInfo.GetYMSFolder() ;
        ...
        //高さ
        double oyaSizeHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName1, 1 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //フランジ幅
        double oyaBHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName1, 2 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //腹板厚半分※Point内ずらしと長さ変更
        double oyaT1Half =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName1, 3 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(10 / 2);
        //フランジ厚
        double oyaT2 =
          ClsRevitUtil.CovertToAPI(
            ClsCommonUtils.ChangeStrToDbl(
              ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName1, 4 ) ) ) ; //ClsRevitUtil.CovertToAPI(15);

        //高さ2
        double oya2SizeHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName2, 1 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //フランジ幅2
        double oya2BHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName2, 2 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //腹板厚半分2
        double oya2T1Half =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName2, 3 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(10 / 2);
        //フランジ厚2
        double oya2T2 =
          ClsRevitUtil.CovertToAPI(
            ClsCommonUtils.ChangeStrToDbl(
              ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName2, 4 ) ) ) ; //ClsRevitUtil.CovertToAPI(15);
        ...
        XYZ sPnt1 = new XYZ( oyaPnt1.X + ( oya2T1Half + yokoyaWidthHalf ) * oyaInst1.HandOrientation.X,
          oyaPnt1.Y + ( oya2T1Half + yokoyaWidthHalf ) * oyaInst1.HandOrientation.Y, oyaPnt1.Z ) ;
        XYZ sPnt2 = new XYZ( oyaPnt2.X - ( oya2T1Half + yokoyaWidthHalf ) * oyaInst2.HandOrientation.X,
          oyaPnt2.Y - ( oya2T1Half + yokoyaWidthHalf ) * oyaInst2.HandOrientation.Y, oyaPnt2.Z ) ;

        oyaPnt1 = new XYZ( oyaPnt1.X + ( oyaBHalf - kakarishiro ) * oyaInst1.HandOrientation.X,
          oyaPnt1.Y + ( oyaBHalf - kakarishiro ) * oyaInst1.HandOrientation.Y, oyaPnt1.Z ) ;
        oyaPnt2 = new XYZ( oyaPnt2.X - ( oya2BHalf - kakarishiro ) * oyaInst2.HandOrientation.X,
          oyaPnt2.Y - ( oya2BHalf - kakarishiro ) * oyaInst2.HandOrientation.Y, oyaPnt2.Z ) ;
        ...
        XYZ ePnt1 = new XYZ( oyaPnt1.X + ( kakarishiro ) * oyaInst1.HandOrientation.X,
          oyaPnt1.Y + ( kakarishiro ) * oyaInst1.HandOrientation.Y, oyaPnt1.Z ) ;
        XYZ ePnt2 = new XYZ( oyaPnt2.X - ( kakarishiro ) * oyaInst2.HandOrientation.X,
          oyaPnt2.Y - ( kakarishiro ) * oyaInst2.HandOrientation.Y, oyaPnt2.Z ) ;
        ...
        if ( m_putPosFlag == 0 ) {
          ...
          sPnt1 = new XYZ( sPnt1.X + oyaSizeHalfIn * oyaInst1.FacingOrientation.X,
            sPnt1.Y + oyaSizeHalfIn * oyaInst1.FacingOrientation.Y, sPnt1.Z ) ;
          ePnt1 = new XYZ( ePnt1.X + oyaSizeHalfIn * oyaInst1.FacingOrientation.X,
            ePnt1.Y + oyaSizeHalfIn * oyaInst1.FacingOrientation.Y, ePnt1.Z ) ;
          kariPnt1 = new XYZ( kariPnt1.X + ( oyaSizeHalfIn - oyaT2 ) * oyaInst1.FacingOrientation.X,
            kariPnt1.Y + ( oyaSizeHalfIn - oyaT2 ) * oyaInst1.FacingOrientation.Y, kariPnt1.Z ) ;

          oyaPnt2 = new XYZ( oyaPnt2.X + oya2SizeHalfIn * oyaInst2.FacingOrientation.X,
            oyaPnt2.Y + oya2SizeHalfIn * oyaInst2.FacingOrientation.Y, oyaPnt2.Z ) ;
          sPnt2 = new XYZ( sPnt2.X + oya2SizeHalfIn * oyaInst2.FacingOrientation.X,
            sPnt2.Y + oya2SizeHalfIn * oyaInst2.FacingOrientation.Y, sPnt2.Z ) ;
          ePnt2 = new XYZ( ePnt2.X + oya2SizeHalfIn * oyaInst2.FacingOrientation.X,
            ePnt2.Y + oya2SizeHalfIn * oyaInst2.FacingOrientation.Y, ePnt2.Z ) ;
          kariPnt2 = new XYZ( kariPnt2.X + ( oya2SizeHalfIn - oyaT2 ) * oyaInst2.FacingOrientation.X,
            kariPnt2.Y + ( oya2SizeHalfIn - oyaT2 ) * oyaInst2.FacingOrientation.Y, kariPnt2.Z ) ;
        }
        else if ( m_putPosFlag == 1 ) {
          //外にずらす
          oyaPnt1 = new XYZ( oyaPnt1.X - oyaSizeHalfOut * oyaInst1.FacingOrientation.X,
          ...
          sPnt1 = new XYZ( sPnt1.X - oyaSizeHalfOut * oyaInst1.FacingOrientation.X,
            sPnt1.Y - oyaSizeHalfOut * oyaInst1.FacingOrientation.Y, sPnt1.Z ) ;
          ePnt1 = new XYZ( ePnt1.X - oyaSizeHalfOut * oyaInst1.FacingOrientation.X,
            ePnt1.Y - oyaSizeHalfOut * oyaInst1.FacingOrientation.Y, ePnt1.Z ) ;
          kariPnt1 = new XYZ( kariPnt1.X - ( oyaSizeHalfOut + oyaT2 ) * oyaInst1.FacingOrientation.X,
            kariPnt1.Y - ( oyaSizeHalfOut + oyaT2 ) * oyaInst1.FacingOrientation.Y, kariPnt1.Z ) ;

          oyaPnt2 = new XYZ( oyaPnt2.X - oya2SizeHalfOut * oyaInst2.FacingOrientation.X,
            oyaPnt2.Y - oya2SizeHalfOut * oyaInst2.FacingOrientation.Y, oyaPnt2.Z ) ;
          sPnt2 = new XYZ( sPnt2.X - oya2SizeHalfOut * oyaInst2.FacingOrientation.X,
            sPnt2.Y - oya2SizeHalfOut * oyaInst2.FacingOrientation.Y, sPnt2.Z ) ;
          ePnt2 = new XYZ( ePnt2.X - oya2SizeHalfOut * oyaInst2.FacingOrientation.X,
            ePnt2.Y - oya2SizeHalfOut * oyaInst2.FacingOrientation.Y, ePnt2.Z ) ;
          kariPnt2 = new XYZ( kariPnt2.X - ( oya2SizeHalfOut + oyaT2 ) * oyaInst2.FacingOrientation.X,
            kariPnt2.Y - ( oya2SizeHalfOut + oyaT2 ) * oyaInst2.FacingOrientation.Y, kariPnt2.Z ) ;
        }
        ...
        if ( insec != null ) {
          oyaPnt1 = new XYZ(
            oyaPnt1.X + ( kakarishiro ) *
            oyaInst1.HandOrientation.X, // - (yokoyaWidthHalf + oyaT2) * oyaInst1.FacingOrientation.X,
            oyaPnt1.Y + ( kakarishiro ) *
            oyaInst1.HandOrientation.Y, // - (yokoyaWidthHalf + oyaT2) * oyaInst1.FacingOrientation.Y,
            oyaPnt1.Z ) ;
          if ( m_putPosFlag == 0 )
            oyaPnt2 = sPnt2 ;
        }
    ...
    /// <returns></returns>
    public bool CreateYokoyaita( Document doc, XYZ pnt, double dAngle, double lenght, double kussaku, ElementId levelId,
      string CASE, double oyaKijyun = 0.0 )
    {
      try {
        string symbolFolpath = ClsZumenInfo.GetYMSFolder() ;
    ...
    public bool CreateMokuyaita( Document doc, ElementId oyaId1, ElementId oyaId2, double lenght, double kussaku,
      ElementId levelId, double oyaKijyun = 0.0 )
    {
      try {
        string symbolFolpath = ClsZumenInfo.GetYMSFolder() ;
        ...
        //高さ
        double oyaSizeHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 1 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //フランジ幅
        double oyaBHalf =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 2 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(300 / 2);
        //腹板厚半分※Point内ずらしと長さ変更
        double oyaT1Half =
          ClsRevitUtil.CovertToAPI( ClsCommonUtils.ChangeStrToDbl( ClsYMSUtil.GetKouzaiSizeSunpou1( oyaSymName, 3 ) ) /
                                    2 ) ; //ClsRevitUtil.CovertToAPI(10 / 2);
        //フランジ厚
        double oyaT2 =
          ClsRevitUtil.CovertToAPI(
    ...
    /// <param name="kussaku">配置する木矢板の高さ</param>
    /// <returns></returns>
    public bool CreateMokuyaita( Document doc, XYZ pnt, double dAngle, double lenght, double kussaku, ElementId levelId,
      string CASE, double oyaKijyun = 0.0 )
    {
      try {
        string familyPath = Master.ClsYokoyaitaCSV.GetFamilyPath( m_size ) ;
    ...
    public static List<List<ElementId>> GroupingOyakui( Document doc, List<ElementId> oyaIdList,
      out List<ElementId> cornerGroupList )
    {
  ...
  public class Yokoyaita
  {
    ...
    public Yokoyaita( XYZ point, double angle, double length, double kussaku, double dHTop, string CASE )
    {
      this.Point = point ;
      this.Angle = angle ;
      this.Length = length ;
