...
namespace YMS.Parts
{
    public class ClsKiribariBase
    {
        ...
        /// <returns></returns>
        public bool ChangeInterSectionKiribariBaseWithKiribariHiuchBase(Document doc, ElementId kiriBaseId, string beforeSize)
        {
        ...
        /// <returns></returns>
        public double GetTotalLength(double dStartAngle, double dEndAngle, ref double dMain, ref double dOffsetA, ref double dOffsetB)
        {
