...
namespace YMS.Parts
{
  public class ClsSyabariUkeBase
  {
    ...
    public bool CreateSyabariUkeBase( Document doc, XYZ tmpStPoint, XYZ tmpEdPoint, XYZ tmpThirdPoint,
      ElementId levelId )
    {
      //参照面の作成
    ...
    public bool CreateSyabariUke( Document doc, ElementId id1, ElementId id3 )
    {
      ...
      foreach ( var pickResult in pickResultSet ) {
        ...
        sectionBottom = ClsYMSUtil.CalcShabariSectionBottom( shabariBaseLine, shabariBasePlane, shabariW, shabariH,
          sectionPlane, dWidth ) ;
    ...
    public void SetClassParameter( Document doc, ElementId id )
    {
      ...
      m_TsukidashiRyoS =
        (int) ClsRevitUtil.GetParameterDouble( doc, id,
          "突き出し量始点" ) ; //ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "突き出し量始点"));
      m_TsukidashiRyoE =
        (int) ClsRevitUtil.GetParameterDouble( doc, id,
          "突き出し量終点" ) ; // ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "突き出し量終点"));
