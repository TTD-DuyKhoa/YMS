...
namespace YMS.Master
{
    public  class ClsSumibuPieceCsv
    {
        ...
        public static string GetSizeName(string type, string shuzaiSize)
        {
            GetCsv();
            string str = string.Empty;
            if ((from data in m_Data where data.Type == type && data.TargetShuzaiSize == shuzaiSize select data.Size).Any())
            {
                str = (from data in m_Data where data.Type == type && data.TargetShuzaiSize == shuzaiSize select data.Size).ToList().First();
            }
        ...
        public static string GetFamilyPath(string type, string shuzaiSize)
        {
            GetCsv();
            string str = string.Empty;
            if ((from data in m_Data where data.Type == type && data.TargetShuzaiSize == shuzaiSize select data.FamilyPath).Any())
            {
                str = (from data in m_Data where data.Type == type && data.TargetShuzaiSize == shuzaiSize select data.FamilyPath).ToList().First();
            }
