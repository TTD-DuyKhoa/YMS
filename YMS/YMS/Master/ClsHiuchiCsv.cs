  ...
  class ClsHiuchiCsv
  {
    ...
    public static List<string> GetTypeListKiribariTsunagiKiriSide()
    {
      ...
      if ( ( from data in m_Data where data.KiribariTsunagiKiriSideFlg == true select data.Type ).Any() ) {
        lst = ( from data in m_Data where data.KiribariTsunagiKiriSideFlg == true select data.Type ).Distinct()
          .ToList() ;
      }
    ...
    public static List<string> GetTypeListKiribariTsunagiHaraSide()
    {
      ...
      if ( ( from data in m_Data where data.KiribariTsunagiHaraSideFlg == true select data.Type ).Any() ) {
        lst = ( from data in m_Data where data.KiribariTsunagiHaraSideFlg == true select data.Type ).Distinct()
          .ToList() ;
      }
    ...
    public static List<string> GetTypeListKiribariHiuchiKiriSide()
    {
      ...
      if ( ( from data in m_Data where data.KiribariHiuchiKiriSideFlg == true select data.Type ).Any() ) {
        lst = ( from data in m_Data where data.KiribariHiuchiKiriSideFlg == true select data.Type ).Distinct()
          .ToList() ;
      }
    ...
    public static List<string> GetTypeListKiribariHiuchiHaraSide()
    {
      ...
      if ( ( from data in m_Data where data.KiribariHiuchiHaraSideFlg == true select data.Type ).Any() ) {
        lst = ( from data in m_Data where data.KiribariHiuchiHaraSideFlg == true select data.Type ).Distinct()
          .ToList() ;
      }
    ...
    public static List<string> GetTypeListKiribariHiuchiSanjikuPieceSide()
    {
      ...
      if ( ( from data in m_Data where data.KiribariHiuchiSanjikuPieceSideFlg == true select data.Type ).Any() ) {
        lst = ( from data in m_Data where data.KiribariHiuchiSanjikuPieceSideFlg == true select data.Type ).Distinct()
          .ToList() ;
      }
    ...
    public static List<string> GetSizeListCornerHiuchi( string type )
    {
      ...
      if ( ( from data in m_Data where data.Type == type && data.CornerHiuchiFlg == true select data.Size ).Any() ) {
        lst = ( from data in m_Data where data.Type == type && data.CornerHiuchiFlg == true select data.Size )
          .ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariTsunagiKiriSide( string type )
    {
      GetCsv() ;
      List<string> lst = new List<string>() ;
      if ( ( from data in m_Data where data.Type == type && data.KiribariTsunagiKiriSideFlg == true select data.Size )
          .Any() ) {
        lst = ( from data in m_Data
          where data.Type == type && data.KiribariTsunagiKiriSideFlg == true
          select data.Size ).ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariTsunagiHaraSide( string type )
    {
      GetCsv() ;
      List<string> lst = new List<string>() ;
      if ( ( from data in m_Data where data.Type == type && data.KiribariTsunagiHaraSideFlg == true select data.Size )
          .Any() ) {
        lst = ( from data in m_Data
          where data.Type == type && data.KiribariTsunagiHaraSideFlg == true
          select data.Size ).ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariHiuchiJouge( string type )
    {
      GetCsv() ;
      List<string> lst = new List<string>() ;
      if ( ( from data in m_Data where data.Type == type && data.KiribariHiuchiJougeFlg == true select data.Size )
          .Any() ) {
        lst = ( from data in m_Data where data.Type == type && data.KiribariHiuchiJougeFlg == true select data.Size )
          .ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariHiuchiKiriSide( string type )
    {
      GetCsv() ;
      List<string> lst = new List<string>() ;
      if ( ( from data in m_Data where data.Type == type && data.KiribariHiuchiKiriSideFlg == true select data.Size )
          .Any() ) {
        lst = ( from data in m_Data where data.Type == type && data.KiribariHiuchiKiriSideFlg == true select data.Size )
          .ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariHiuchiHaraSide( string type )
    {
      GetCsv() ;
      List<string> lst = new List<string>() ;
      if ( ( from data in m_Data where data.Type == type && data.KiribariHiuchiHaraSideFlg == true select data.Size )
          .Any() ) {
        lst = ( from data in m_Data where data.Type == type && data.KiribariHiuchiHaraSideFlg == true select data.Size )
          .ToList() ;
      }
    ...
    public static List<string> GetSizeListKiribariHiuchiSanjikuPieceSide( string type )
    {
      ...
      if ( ( from data in m_Data
            where data.Type == type && data.KiribariHiuchiSanjikuPieceSideFlg == true
    ...
    public static double GetWidth( string type, string size )
    {
      ...
      if ( ( from data in m_Data where data.Type == type && data.Size == size select data.TargetShuzai ).Any() ) {
        str = ( from data in m_Data where data.Type == type && data.Size == size select data.TargetShuzai ).ToList()
          .First() ;
      }
    ...
    public static string GetSize( string type, string TargetShuzai )
    {
      GetCsv() ;
      string str = string.Empty ;
      if ( ( from data in m_Data where data.Type == type && data.TargetShuzai == TargetShuzai select data.Size )
          .Any() ) {
        str = ( from data in m_Data where data.Type == type && data.TargetShuzai == TargetShuzai select data.Size )
          .ToList().First() ;
      }
    ...
    public static double GetThickness( string type, string TargetShuzai )
    {
      GetCsv() ;
      double d = 0 ;
      if ( ( from data in m_Data where data.Type == type && data.TargetShuzai == TargetShuzai select data.Thickness )
          .Any() ) {
        d = ( from data in m_Data where data.Type == type && data.TargetShuzai == TargetShuzai select data.Thickness )
          .ToList().First() ;
      }
    ...
    public static string GetFamilyPath( string type, string TargetShuzai )
    {
      GetCsv() ;
      string str = string.Empty ;
      if ( ( from data in m_Data where data.Type == type && data.TargetShuzai == TargetShuzai select data.FamilyPath )
          .Any() ) {
        str = ( from data in m_Data
          where data.Type == type && data.TargetShuzai == TargetShuzai
