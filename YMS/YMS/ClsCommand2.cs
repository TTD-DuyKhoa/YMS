...
namespace YMS
{
    ...
    {
        public static void CreateShabariHiuchi(
            Document doc,
            ElementId shaBaseId,
            ElementId haraBaseId,
            XYZ haraSelectedPt,
            double hiuchiLength,
            FamilySymbol shaPiece,
            FamilySymbol haraPiece
            )
        {
            ...
            var haraSection = Plane.CreateByNormalAndOrigin(normal: haraBaseLine.Direction.CrossProduct(XYZ.BasisZ), origin: haraBaseLine.Origin);
