...
namespace YMS.DLG
{
  public partial class DlgCreateKiribariTsugiBase : Form
  {
    ...
    public void initComboBox()
    {
      ...
      lstStr = new List<string>() { Master.ClsYamadomeCsv.TypeShuzai, Master.ClsHBeamCsv.TypeHiro } ;
    ...
    private void GetIniData()
    {
      try {
        ...
        rbnShoriTypeSanjikuPeace.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnShoriTypeSanjikuPeace.Name, iniPath ) ) ;
    ...
    private void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnShoriTypeSanjikuPeace.Name, rbnShoriTypeSanjikuPeace.Checked.ToString(),
        iniPath ) ;
      ...
      ClsIni.WritePrivateProfileString( sec, cmbKiriSideSteelSizeDouble.Name, cmbKiriSideSteelSizeDouble.Text,
        iniPath ) ;
      ...
      ClsIni.WritePrivateProfileString( sec, cmbHaraSideSteelSizeDouble.Name, cmbHaraSideSteelSizeDouble.Text,
        iniPath ) ;
