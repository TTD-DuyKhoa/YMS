  ...
  public partial class DlgCreateKiribariHiuchiBase : Form
  {
    ...
    private void GetIniData()
    {
      try {
        ...
        rbnHaichiShoriHohoManual.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnHaichiShoriHohoManual.Name, iniPath ) ) ;
        rbnHaichiShoriHohoReplace.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnHaichiShoriHohoReplace.Name, iniPath ) ) ;

        rbnHaichiCreateHohoBoth.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnHaichiCreateHohoBoth.Name, iniPath ) ) ;
        rbnHaichiCreateHohoAnyLengthManual.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnHaichiCreateHohoAnyLengthManual.Name, iniPath ) ) ;
        rbnHaichiCreateHohoAnyLengthAuto.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnHaichiCreateHohoAnyLengthAuto.Name, iniPath ) ) ;
    ...
    private void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnHaichiSanjikuHara.Name, rbnHaichiSanjikuHara.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHaichiShoriHohoAuto.Name, rbnHaichiShoriHohoAuto.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHaichiShoriHohoManual.Name, rbnHaichiShoriHohoManual.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHaichiShoriHohoReplace.Name,
        rbnHaichiShoriHohoReplace.Checked.ToString(), iniPath ) ;

      ClsIni.WritePrivateProfileString( sec, rbnHaichiCreateHohoBoth.Name, rbnHaichiCreateHohoBoth.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHaichiCreateHohoAnyLengthManual.Name,
        rbnHaichiCreateHohoAnyLengthManual.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHaichiCreateHohoAnyLengthAuto.Name,
        rbnHaichiCreateHohoAnyLengthAuto.Checked.ToString(), iniPath ) ;

      ClsIni.WritePrivateProfileString( sec, rbnCreateHouhouSingle.Name, rbnCreateHouhouSingle.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnCreateHouhouDouble.Name, rbnCreateHouhouDouble.Checked.ToString(),
        iniPath ) ;
