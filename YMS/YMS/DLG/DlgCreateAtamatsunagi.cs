...
namespace YMS.DLG
{
  public partial class DlgCreateAtamatsunagi : System.Windows.Forms.Form
  {
    ...
    private void setIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnChannelDirection1.Name, rbnChannelDirection1.Checked.ToString(),
        path ) ;
      ClsIni.WritePrivateProfileString( sec, rbnChannelDirection2.Name, rbnChannelDirection2.Checked.ToString(),
        path ) ;
    ...
    public bool checkInput()
    {
      ...
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtBoltNum, "ボルト本数", bMinus: true, bZero: true,
            bComma: true ) ) //#33920
      {
        return false ;
      }
