...
namespace YMS.DLG
{
  public partial class DlgCreateStiffener : System.Windows.Forms.Form
  {
    ...
    {
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtKiriCount, "切梁個数", bMinus: true, bComma: true, bMax: true,
            dMax: 3 ) )
        return false ;
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtHiuchiKiriSideCount, "切梁側個数", bMinus: true, bComma: true,
            bMax: true, dMax: 3 ) )
        return false ;
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtHiuchiHiuchiiSideCount, "火打側個数", bMinus: true, bComma: true,
            bMax: true, dMax: 3 ) )
        return false ;
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtKiriHiuchiCount, "切梁火打個数", bMinus: true, bComma: true, bMax: true,
            dMax: 3 ) )
        return false ;
      if ( ! ClsCommonUtils.ChkContorolTextDouble( txtCount, "隅火打個数", bMinus: true, bComma: true, bMax: true,
            dMax: 3 ) )
        return false ;
      return true ;
    }
    ...
    public void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnKiriPlateTypeDef.Name, rbnKiriPlateTypeDef.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriPlateTypeAtsu.Name, rbnKiriPlateTypeAtsu.Checked.ToString(),
        iniPath ) ;
      ...
      ClsIni.WritePrivateProfileString( sec, rbnHiuchiJackTypeSH.Name, rbnHiuchiJackTypeSH.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHiuchiJackTypeDWJ.Name, rbnHiuchiJackTypeDWJ.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHiuchiPlateTypeDef.Name, rbnHiuchiPlateTypeDef.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnHiuchiPlateTypeAtsu.Name, rbnHiuchiPlateTypeAtsu.Checked.ToString(),
        iniPath ) ;
      ...
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiTypePlate.Name, rbnKiriHiuchiTypePlate.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiTypeJack.Name, rbnKiriHiuchiTypeJack.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiJackTypeSH.Name, rbnKiriHiuchiJackTypeSH.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiJackTypeDWJ.Name, rbnKiriHiuchiJackTypeDWJ.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiPlateTypeDef.Name,
        rbnKiriHiuchiPlateTypeDef.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnKiriHiuchiPlateTypeAtsu.Name,
        rbnKiriHiuchiPlateTypeAtsu.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, txtKiriHiuchiCount.Name, txtKiriHiuchiCount.Text, iniPath ) ;

      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiTypePlate.Name, rbnSumiHiuchiTypePlate.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiTypeJack.Name, rbnSumiHiuchiTypeJack.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiJackTypeSH.Name, rbnSumiHiuchiJackTypeSH.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiPlateJackTypeDWJ.Name,
        rbnSumiHiuchiPlateJackTypeDWJ.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiPlateTypeDef.Name,
        rbnSumiHiuchiPlateTypeDef.Checked.ToString(), iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnSumiHiuchiPlateTypeAtsu.Name,
        rbnSumiHiuchiPlateTypeAtsu.Checked.ToString(), iniPath ) ;
    ...
    public void GetIniData()
    {
      ...
      rbnKiriHiuchiJackTypeDWJ.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnKiriHiuchiJackTypeDWJ.Name, iniPath ) ) ;
      rbnKiriHiuchiPlateTypeDef.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnKiriHiuchiPlateTypeDef.Name, iniPath ) ) ;
      rbnKiriHiuchiPlateTypeAtsu.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnKiriHiuchiPlateTypeAtsu.Name, iniPath ) ) ;
      ...
      rbnSumiHiuchiPlateJackTypeDWJ.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnSumiHiuchiPlateJackTypeDWJ.Name, iniPath ) ) ;
      rbnSumiHiuchiPlateTypeDef.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnSumiHiuchiPlateTypeDef.Name, iniPath ) ) ;
      rbnSumiHiuchiPlateTypeAtsu.Checked =
        bool.Parse( ClsIni.GetIniFile( sec, rbnSumiHiuchiPlateTypeAtsu.Name, iniPath ) ) ;
