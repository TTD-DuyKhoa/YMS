  ...
  public partial class DlgCreateYokoyaita : Form
  {
    ...
    private void GetIniData()
    {
      try {
        ...
        rbnInside.Checked =
          RevitUtil.ClsCommonUtils.ChangeStrToBool( ClsIni.GetIniFile( sec, rbnInside.Name, iniPath ) ) ;
        rbnOutSide.Checked =
          RevitUtil.ClsCommonUtils.ChangeStrToBool( ClsIni.GetIniFile( sec, rbnOutSide.Name, iniPath ) ) ;
      }
      catch {
