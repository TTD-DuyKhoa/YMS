...
namespace YMS.DLG
{
  public partial class DlgCreateHiuchiTsunagizaiBase : Form
  {
    ...
    public void initComboBox()
    {
      ...
      List<string> steelTypes = new List<string>()
      {
    ...
    private void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnToritsukeBuruman.Name, rbnToritsukeBuruman.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnToritsukeRikiman.Name, rbnToritsukeRikiman.Checked.ToString(),
        iniPath ) ;
