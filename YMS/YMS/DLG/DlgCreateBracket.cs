...
namespace YMS.DLG
{
  public partial class DlgCreateBracket : System.Windows.Forms.Form
  {
    ...
    private void initComboBoxBracketSize()
    {
      if ( cmbBracketSize != null ) {
        ...
        var RadioButtonChecked_InGroup =
          grpBracketType.Controls.OfType<RadioButton>().SingleOrDefault( rb => rb.Checked == true ) ;
    ...
    {
      var RBChecked_InGroup_Mode =
        grpCreateMode.Controls.OfType<RadioButton>().SingleOrDefault( rb => rb.Checked == true ) ;
