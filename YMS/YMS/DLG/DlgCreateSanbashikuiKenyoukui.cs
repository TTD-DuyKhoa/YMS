...
namespace YMS.DLG
{
    public partial class DlgCreateSanbashikuiKenyoukui : System.Windows.Forms.Form
    {
        ...
        private void SetIniData()
        {
            ...
            ClsIni.WritePrivateProfileString(sec, rbnPileTypeDanmenHenka.Name, rbnPileTypeDanmenHenka.Checked.ToString(), path);
            ...
            ClsIni.WritePrivateProfileString(sec, rbnKoteiTypeYosetsu2.Name, rbnKoteiTypeYosetsu2.Checked.ToString(), path);
        ...
        private bool SetData()
        {
            ...
            var RadioButtonChecked_InGroup = grpPileType.Controls.OfType<RadioButton>().SingleOrDefault(rb => rb.Checked == true);
            ...
            if (rbnTopPlateOn.Checked)
            {
                ...
                {
                    if (cmbTopPlateSizeTeigata.SelectedItem == null) { return false; }
            ...
            if (cmbEndPlateThickness.SelectedItem == null) { return false; }
