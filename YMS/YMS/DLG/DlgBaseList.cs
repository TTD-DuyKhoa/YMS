...
namespace YMS.DLG
{
  public partial class DlgBaseList : System.Windows.Forms.Form
  {
    ...
    /// コンストラクタ
    /// </summary>
    public DlgBaseList( Document doc, ExternalEvent exEvent, RequestHandler handler, List<ClsHaraokoshiBase> lstH,
      List<ClsKiribariBase> lstK, List<ClsCornerHiuchiBase> lstHB, List<ClsKiribariHiuchiBase> lstKH,
      List<ClsKiribariUkeBase> lstKU, List<ClsKiribariTsunagizaiBase> lstKT, List<ClsHiuchiTsunagizaiBase> lstHT,
      List<ClsKiribariTsugiBase> lstKTsugi, List<ClsSyabariBase> lstSB, List<ClsSyabariTsunagizaiBase> lstST,
    ...
    private void SetDataGridViewHaraokoshi( int nIndex, ClsHaraokoshiBase data )
    {
      ...
      dgv[ dgv.Columns.IndexOf( clmH_YokoNum ), nIndex ].Value =
        ( data.m_yoko == ClsHaraokoshiBase.SideNum.Single ? "シングル" : "ダブル" ) ;
      dgv[ dgv.Columns.IndexOf( clmH_TateNum ), nIndex ].Value =
        ( data.m_tate == ClsHaraokoshiBase.VerticalNum.Single ? "シングル" : "ダブル" ) ;
    ...
    private void EditHaraokoshi()
    {
      ...
      foreach ( DataGridViewRow row in dgvHaraokoshi.SelectedRows ) {
        ...
        sameBase.m_ShoriType =
          templateBase.m_ShoriType ; //ClsRevitUtil.CompareValues(compareBase.m_ShoriType, templateBase.m_ShoriType);
        sameBase.m_level =
          templateBase.m_level ; // ClsRevitUtil.CompareValues(compareBase.m_level, templateBase.m_level);
        ...
        sameBase.m_kouzaiType =
          templateBase
            .m_kouzaiType ; // ClsRevitUtil.CompareValues(compareBase.m_kouzaiType, templateBase.m_kouzaiType);
        sameBase.m_kouzaiSize =
          templateBase
            .m_kouzaiSize ; // ClsRevitUtil.CompareValues(compareBase.m_kouzaiSize, templateBase.m_kouzaiSize);
        ...
        sameBase.m_gapTyouseiType =
          templateBase
            .m_gapTyouseiType ; // ClsRevitUtil.CompareValues(compareBase.m_gapTyouseiType, templateBase.m_gapTyouseiType);
        sameBase.m_gapTyousei =
          templateBase
            .m_gapTyousei ; // ClsRevitUtil.CompareValues(compareBase.m_gapTyousei, templateBase.m_gapTyousei);
        sameBase.m_gapTyouseiLenght =
          ClsRevitUtil.CompareValues( compareBase.m_gapTyouseiLenght, templateBase.m_gapTyouseiLenght ) ;
        sameBase.m_katimake =
          templateBase.m_katimake ; // ClsRevitUtil.CompareValues(compareBase.m_katimake, templateBase.m_katimake);
      }
    ...
    private void EditKiribari()
    {
      ...
      foreach ( DataGridViewRow row in dgvKiribari.SelectedRows ) {
        ...
        sameBase.m_ShoriType =
          templateBase.m_ShoriType ; // ClsRevitUtil.CompareValues(compareBase.m_ShoriType, templateBase.m_ShoriType);
        sameBase.m_tanbuStart =
          templateBase
            .m_tanbuStart ; // ClsRevitUtil.CompareValues(compareBase.m_tanbuStart, templateBase.m_tanbuStart);
        sameBase.m_tanbuEnd =
          templateBase.m_tanbuEnd ; // ClsRevitUtil.CompareValues(compareBase.m_tanbuEnd, templateBase.m_tanbuEnd);
        sameBase.m_jack1 =
          templateBase.m_jack1 ; // ClsRevitUtil.CompareValues(compareBase.m_jack1, templateBase.m_jack1);
        sameBase.m_jack2 =
          templateBase.m_jack2 ; // ClsRevitUtil.CompareValues(compareBase.m_jack2, templateBase.m_jack2);
    ...
    private void SetDataGridViewCornerHiuchi( int nIndex, ClsCornerHiuchiBase data )
    {
      ...
      dgv[ dgv.Columns.IndexOf( clmCH_Kousei ), nIndex ].Value =
        ( data.m_Kousei == ClsCornerHiuchiBase.Kousei.Single ? "シングル" : "ダブル" ) ;
      dgv[ dgv.Columns.IndexOf( clmCH_Angle ), nIndex ].Value =
        ( data.m_HiuchiAngle == ClsCornerHiuchiBase.HiuchiAngle.Toubun ? "等分" : "任意" ) ;
      ...
      dgv[ dgv.Columns.IndexOf( clmCH_HiuchiLengthDoubleL1 ), nIndex ].Value =
        data.m_HiuchiLengthDoubleUpperL1.ToString() ;
      dgv[ dgv.Columns.IndexOf( clmCH_HiuchiLengthDoubleL2 ), nIndex ].Value =
        data.m_HiuchiLengthDoubleUnderL2.ToString() ;
    ...
    private void EditCornerHiuchi()
    {
      ...
      foreach ( DataGridViewRow row in dgvCornerHiuchi.SelectedRows ) {
        ...
        sameBase.m_Kousei =
          templateBase.m_Kousei ; // ClsRevitUtil.CompareValues(compareBase.m_Kousei, templateBase.m_Kousei);
        sameBase.m_HiuchiAngle =
          templateBase
            .m_HiuchiAngle ; // ClsRevitUtil.CompareValues(compareBase.m_HiuchiAngle, templateBase.m_HiuchiAngle);
        sameBase.m_angle = ClsRevitUtil.CompareValues( compareBase.m_angle, templateBase.m_angle ) ;
        sameBase.m_SteelType =
          templateBase.m_SteelType ; // ClsRevitUtil.CompareValues(compareBase.m_SteelType, templateBase.m_SteelType);
        sameBase.m_SteelSize =
          templateBase.m_SteelSize ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSize, templateBase.m_SteelSize);
        sameBase.m_TanbuParts1 =
          templateBase
            .m_TanbuParts1 ; // ClsRevitUtil.CompareValues(compareBase.m_TanbuParts1, templateBase.m_TanbuParts1);
        sameBase.m_HiuchiUkePieceSize1 =
          templateBase
            .m_HiuchiUkePieceSize1 ; // ClsRevitUtil.CompareValues(compareBase.m_HiuchiUkePieceSize1, templateBase.m_HiuchiUkePieceSize1);
        sameBase.m_TanbuParts2 =
          templateBase
            .m_TanbuParts2 ; // ClsRevitUtil.CompareValues(compareBase.m_TanbuParts2, templateBase.m_TanbuParts2);
        sameBase.m_HiuchiUkePieceSize2 =
          templateBase
            .m_HiuchiUkePieceSize2 ; // ClsRevitUtil.CompareValues(compareBase.m_HiuchiUkePieceSize2, templateBase.m_HiuchiUkePieceSize2);
        sameBase.m_HiuchiTotalLength =
          ClsRevitUtil.CompareValues( compareBase.m_HiuchiTotalLength, templateBase.m_HiuchiTotalLength ) ;
        sameBase.m_HiuchiLengthSingleL =
          ClsRevitUtil.CompareValues( compareBase.m_HiuchiLengthSingleL, templateBase.m_HiuchiLengthSingleL ) ;
        sameBase.m_HiuchiLengthDoubleUpperL1 = ClsRevitUtil.CompareValues( compareBase.m_HiuchiLengthDoubleUpperL1,
          templateBase.m_HiuchiLengthDoubleUpperL1 ) ;
        sameBase.m_HiuchiLengthDoubleUnderL2 = ClsRevitUtil.CompareValues( compareBase.m_HiuchiLengthDoubleUnderL2,
          templateBase.m_HiuchiLengthDoubleUnderL2 ) ;
        sameBase.m_HiuchiZureryo =
          ClsRevitUtil.CompareValues( compareBase.m_HiuchiZureryo, templateBase.m_HiuchiZureryo ) ;
      }
    ...
    private void SetDataGridViewKiribariHiuchi( int nIndex, ClsKiribariHiuchiBase data )
    {
      ...
      dgv[ dgv.Columns.IndexOf( clmKH_SingleDouble ), nIndex ].Value =
        ( data.m_CreateHoho == ClsKiribariHiuchiBase.CreateHoho.Single ? "シングル" : "ダブル" ) ;
      ...
      dgv[ dgv.Columns.IndexOf( clmKH_HiuchiLengthDoubleL1 ), nIndex ].Value =
        data.m_HiuchiLengthDoubleUpperL1.ToString() ;
      dgv[ dgv.Columns.IndexOf( clmKH_HiuchiLengthDoubleL2 ), nIndex ].Value =
        data.m_HiuchiLengthDoubleUnderL2.ToString() ;
    ...
    private void EditKiribariHiuchi()
    {
      ...
      foreach ( DataGridViewRow row in dgvKiribariHiuchi.SelectedRows ) {
        ...
        sameBase.m_SteelSizeSingle =
          templateBase
            .m_SteelSizeSingle ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSizeSingle, templateBase.m_SteelSizeSingle);
        sameBase.m_SteelSizeDoubleUpper =
          templateBase
            .m_SteelSizeDoubleUpper ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSizeDoubleUpper, templateBase.m_SteelSizeDoubleUpper);
        sameBase.m_SteelSizeDoubleUnder =
          templateBase
            .m_SteelSizeDoubleUnder ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSizeDoubleUnder, templateBase.m_SteelSizeDoubleUnder);
        sameBase.m_HiuchiLengthSingleL =
          ClsRevitUtil.CompareValues( compareBase.m_HiuchiLengthSingleL, templateBase.m_HiuchiLengthSingleL ) ;
        sameBase.m_HiuchiLengthDoubleUpperL1 = ClsRevitUtil.CompareValues( compareBase.m_HiuchiLengthDoubleUpperL1,
          templateBase.m_HiuchiLengthDoubleUpperL1 ) ;
        ...
        sameBase.m_HiuchiZureRyo =
          ClsRevitUtil.CompareValues( compareBase.m_HiuchiZureRyo, templateBase.m_HiuchiZureRyo ) ;
        sameBase.m_PartsTypeKiriSide =
          templateBase
            .m_PartsTypeKiriSide ; // ClsRevitUtil.CompareValues(compareBase.m_PartsTypeKiriSide, templateBase.m_PartsTypeKiriSide);
        sameBase.m_PartsSizeKiriSide =
          templateBase
            .m_PartsSizeKiriSide ; // ClsRevitUtil.CompareValues(compareBase.m_PartsSizeKiriSide, templateBase.m_PartsSizeKiriSide);
        sameBase.m_PartsTypeHaraSide =
          templateBase
            .m_PartsTypeHaraSide ; // ClsRevitUtil.CompareValues(compareBase.m_PartsTypeHaraSide, templateBase.m_PartsTypeHaraSide);
        sameBase.m_PartsSizeHaraSide =
          templateBase
            .m_PartsSizeHaraSide ; // ClsRevitUtil.CompareValues(compareBase.m_PartsSizeHaraSide, templateBase.m_PartsSizeHaraSide);
        sameBase.m_Angle = ClsRevitUtil.CompareValues( compareBase.m_Angle, templateBase.m_Angle ) ;
      }
    ...
    private void EditKiribariUke()
    {
      ...
      foreach ( DataGridViewRow row in dgvKiribariUke.SelectedRows ) {
        ...
        sameBase.m_SteelSize =
          templateBase.m_SteelSize ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSize, templateBase.m_SteelSize);
        sameBase.m_TsukidashiRyoS =
          ClsRevitUtil.CompareValues( compareBase.m_TsukidashiRyoS, templateBase.m_TsukidashiRyoS ) ;
        sameBase.m_TsukidashiRyoE =
          ClsRevitUtil.CompareValues( compareBase.m_TsukidashiRyoE, templateBase.m_TsukidashiRyoE ) ;
      }
    ...
    private void EditKiribariTsunagizai()
    {
      ...
      foreach ( DataGridViewRow row in dgvKiribariTsunagi.SelectedRows ) {
        ...
        sameBase.m_ToritsukeHoho =
          templateBase
            .m_ToritsukeHoho ; // ClsRevitUtil.CompareValues(compareBase.m_ToritsukeHoho, templateBase.m_ToritsukeHoho);
        sameBase.m_ShoriType = ClsRevitUtil.CompareValues( compareBase.m_ShoriType, templateBase.m_ShoriType ) ;
        sameBase.m_BoltType1 =
          templateBase.m_BoltType1 ; // ClsRevitUtil.CompareValues(compareBase.m_BoltType1, templateBase.m_BoltType1);
        sameBase.m_BoltType2 =
          templateBase.m_BoltType2 ; // ClsRevitUtil.CompareValues(compareBase.m_BoltType2, templateBase.m_BoltType2);
      ...
      if ( res == DialogResult.OK ) {
        ...
        foreach ( DataGridViewRow row in dgvKiribariTsunagi.SelectedRows ) {
          ClsKiribariTsunagizaiBase
            originalBase = (ClsKiribariTsunagizaiBase) dgvKiribariTsunagi.Rows[ row.Index ].Tag ;
          originalBase.m_FlgEdit = true ;
          originalBase.m_SteelType = data.m_SteelType ;
          originalBase.m_SteelSize = data.m_SteelSize ;
          originalBase.m_ShoriType = data.m_ShoriType ;
    ...
    private void SetDataGridViewKiribariTsugi( int nIndex, ClsKiribariTsugiBase data )
    {
      ...
      dgv[ dgv.Columns.IndexOf( clmKTsugi_Kosei ), nIndex ].Value =
        ( data.m_Kousei == ClsKiribariTsugiBase.Kousei.Single ? "シングル" : "ダブル" ) ;
    ...
    private void EditKiribariTsugi()
    {
      ...
      foreach ( DataGridViewRow row in dgvKiribariTsugi.SelectedRows ) {
        ...
        sameBase.m_SteelSizeSingle =
          templateBase
            .m_SteelSizeSingle ; // ClsRevitUtil.CompareValues(compareBase.m_SteelSizeSingle, templateBase.m_SteelSizeSingle);
        sameBase.m_KiriSideSteelSizeDouble =
          templateBase
            .m_KiriSideSteelSizeDouble ; // ClsRevitUtil.CompareValues(compareBase.m_KiriSideSteelSizeDouble, templateBase.m_KiriSideSteelSizeDouble);
        sameBase.m_KiriSideTsunagiLength = ClsRevitUtil.CompareValues( compareBase.m_KiriSideTsunagiLength,
          templateBase.m_KiriSideTsunagiLength ) ;
        sameBase.m_KiriSideParts =
          templateBase
            .m_KiriSideParts ; // ClsRevitUtil.CompareValues(compareBase.m_KiriSideParts, templateBase.m_KiriSideParts);
        sameBase.m_HaraSideSteelSizeDouble =
          templateBase
            .m_HaraSideSteelSizeDouble ; // ClsRevitUtil.CompareValues(compareBase.m_HaraSideSteelSizeDouble, templateBase.m_HaraSideSteelSizeDouble);
        sameBase.m_HaraSideTsunagiLength = ClsRevitUtil.CompareValues( compareBase.m_HaraSideTsunagiLength,
          templateBase.m_HaraSideTsunagiLength ) ;
        sameBase.m_HaraSideParts =
          templateBase
            .m_HaraSideParts ; // ClsRevitUtil.CompareValues(compareBase.m_HaraSideParts, templateBase.m_HaraSideParts);
      }
