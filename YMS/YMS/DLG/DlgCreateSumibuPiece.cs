  ...
  public partial class DlgCreateSumibuPiece : Form
  {
    ...
    private void GetIniData()
    {
      try {
        ...
        rbnCreateTypeAuto.Checked =
          RevitUtil.ClsCommonUtils.ChangeStrToBool( ClsIni.GetIniFile( sec, rbnCreateTypeAuto.Name, iniPath ) ) ;
        rbnCreateTypeManual.Checked =
          RevitUtil.ClsCommonUtils.ChangeStrToBool( ClsIni.GetIniFile( sec, rbnCreateTypeManual.Name, iniPath ) ) ;
        ...
        chkSumibuPeaceSize.Checked =
          RevitUtil.ClsCommonUtils.ChangeStrToBool( ClsIni.GetIniFile( sec, chkSumibuPeaceSize.Name, iniPath ) ) ;
    ...
    private void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnCreateTypeManual.Name, rbnCreateTypeManual.Checked.ToString(),
        iniPath ) ;
