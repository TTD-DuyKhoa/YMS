  ...
  public partial class DlgCreateHaraokoshiBase : System.Windows.Forms.Form
  {
    ...
    public void SetData()
    {
      ...
      var RadioButtonChecked_InGroup =
        groupBox3.Controls.OfType<RadioButton>().SingleOrDefault( rb => rb.Checked == true ) ;
    ...
    private void GetIniData()
    {
      try {
        ...
        rbnShoriTypeBaseLineOut.Checked =
          bool.Parse( ClsIni.GetIniFile( sec, rbnShoriTypeBaseLineOut.Name, iniPath ) ) ;
    ...
    private void SetIniData()
    {
      ...
      ClsIni.WritePrivateProfileString( sec, rbnShoriTypeBaseLineOut.Name, rbnShoriTypeBaseLineOut.Checked.ToString(),
        iniPath ) ;
      ClsIni.WritePrivateProfileString( sec, rbnShoriTypePtoPOut.Name, rbnShoriTypePtoPOut.Checked.ToString(),
        iniPath ) ;
