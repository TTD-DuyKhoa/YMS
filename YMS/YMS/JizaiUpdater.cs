...
namespace YMS
{
  class Updater01 : IUpdater
  {
    ...
    public Updater01( Document doc, AddInId addInId, DLG.DlgKobetsuHaichi_Jizai.EnumPtn ptn, bool actFlg,
      bool isleft = true )
    {
      m_isleft = isleft ;
      m_ptn = ptn ;
    ...
    public void RegisterTriggers()
    {
      if ( this.updater != null && UpdaterRegistry.IsUpdaterRegistered( this.updater ) ) {
        UpdaterRegistry.RemoveAllTriggers( this.updater ) ;
        UpdaterRegistry.AddTrigger( this.updater, new ElementClassFilter( typeof( FamilyInstance ) ),
