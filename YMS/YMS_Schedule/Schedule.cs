...
namespace YMS_Schedule
{
    public class Schedule
    {
        ...
        public static ViewSchedule view(Document doc)
        {
            ...
            return new FilteredElementCollector(doc).OfClass(typeof(ViewSchedule)).FirstOrDefault<Element>(e => e.Name.Equals(schduleName)) as ViewSchedule;
        }
                    ...
                    if (!Schedule.isYMS(x.items[indexItem1], x.items[indexItem2], x.items[indexItem3]))
                    {
                        ...
                        if(fi != null)
                        {
                            ...
                            foreach (var y in nest)
                            {
                                ...
                                if (Schedule.isYMS(itms[idx].items[indexItem1], itms[idx].items[indexItem2], itms[idx].items[indexItem3]))
                                {
                                    bUse = true;
                                    break;
                                }
