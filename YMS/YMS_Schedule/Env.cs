...
namespace YMS_Schedule
{
  class Env
  {
    ...
    {
      string res = iPath ;
      if ( ! string.IsNullOrEmpty( iPath ) && ! Path.IsPathRooted( iPath ) ) {
    ...
    static public void ribbonButtonAdd( RibbonPanel panel, string btnName, string cmdName, string tooltip,
      string imageL, string imageS )
    {
    ...
    static public void ribbonButtonAdd( RibbonPanel panel, string btnName, string btnText, string cmdName,
      string tooltip, string imageL, string imageS )
    {
      PushButtonData pbDataExtCmd1 = new PushButtonData( btnName, btnText,
        System.Reflection.Assembly.GetExecutingAssembly().Location, cmdName ) ;
