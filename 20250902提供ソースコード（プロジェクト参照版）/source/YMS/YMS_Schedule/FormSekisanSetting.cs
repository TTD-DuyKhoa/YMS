...
namespace YMS_Schedule
{
    ...
    public partial class FormSekisanSetting : Form
    {
        ...
        private void EnableControl(object sender, EventArgs e)
        {
            ...
            //杭
            if (cmbKetaShugetaKetauke.Text == "なし" || 
                cmbKetaShugetaKetauke.Text == "ブルマン" ||
            ...
            if (cmbKetaShugetaKetaukeSlope.Text == "なし" || 
                cmbKetaShugetaKetaukeSlope.Text == "ブルマン" ||
            ...
            if (cmbKetaKetaukeKetauke.Text == "なし" || 
                cmbKetaKetaukeKetauke.Text == "ブルマン" ||
            ...
            //杭
            if (cmbKuiKuiKetauke.Text == "なし" || 
                cmbKuiKuiKetauke.Text == "ブルマン" ||
               cmbKuiKuiKetauke.Text == "溶接")
            {
        ...
        private bool SetData()
        {
            ...
            try
            {
                ...
                clsSS.KiriKiriPlateThickness = RevitUtil.ClsCommonUtils.ChangeStrToDbl(txtKiriKiriPlateThickness.Text.ToString());
                clsSS.KiriKoteiHoho = cmbKiriKoteiHoho.Text.ToString();
                clsSS.KiriFlangeSiedeBoltNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKiriFlangeSideBoltNum.Text.ToString());
                clsSS.KiriWebSiedeBoltNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKiriWebSideBoltNum.Text.ToString());
                clsSS.KiriToritsukeHojoAndPile = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKiriToritsukeHojoAndPile.Text.ToString());
                ...
                clsSS.VerVerPlateThickness = RevitUtil.ClsCommonUtils.ChangeStrToDbl(txtVerVerPlateThickness.Text.ToString());
                ...
                clsSS.VerFlangeSiedeBoltNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtVerFlangeSideBoltNum.Text.ToString());
                clsSS.VerWebSiedeBoltNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtVerWebSideBoltNum.Text.ToString());
                clsSS.VerToritsukeHojoAndPile = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtVerToritsukeHojoAndPile.Text.ToString());

                clsSS.KetaShugetaKetauke = cmbKetaShugetaKetauke.Text.ToString();
                clsSS.KetaShugetaKetaukeNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKetaShugetaKetaukeNum.Text.ToString());
                clsSS.KetaShugetaKetaukeSlope = cmbKetaShugetaKetaukeSlope.Text.ToString();
                clsSS.KetaShugetaKetaukeSlopeNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKetaShugetaKetaukeSlopeNum.Text.ToString());
                clsSS.KetaKetaukeKetauke = cmbKetaKetaukeKetauke.Text.ToString();
                clsSS.KetaKetaukeKetaukeNum = RevitUtil.ClsCommonUtils.ChangeStrToInt(txtKetaKetaukeKetaukeNum.Text.ToString());
        ...
        private bool SetDefaultData()
        {
            try
            {
                ...
                FieldInfo[] formSekisanSettingFields = formSekisanSetting.GetFields(BindingFlags.NonPublic | BindingFlags.Instance);
