...
{
    public class ClsShimetukePieceCsv
    {
        #region メンバ変数
        ...
        /// CSV名称
        /// </summary>
        private const string CsvFileName = "ShimetukePiece.csv";

        /// <summary>
        /// メンバ変数
        /// </summary>
        private static List<ClsShimetukePieceCsv> m_Data = new List<ClsShimetukePieceCsv>();
        ...
        public static bool GetCsv()
        {
            ...
            bool bHeader = true;
            List<ClsShimetukePieceCsv> lstCls = new List<ClsShimetukePieceCsv>();
            foreach (List<string> lstStr in lstlstStr)
            {
                ...
                ClsShimetukePieceCsv cls = new ClsShimetukePieceCsv();
                cls.Size = lstStr[0];
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ClsShimetukePieceCsv> GetCsvData()
        {
            GetCsv();
            return m_Data;
        }
