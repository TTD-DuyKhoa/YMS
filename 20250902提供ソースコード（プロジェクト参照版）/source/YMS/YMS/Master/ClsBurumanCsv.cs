...
namespace YMS.Master
{
    class ClsBurumanCSV
    {
        ...
        /// CSV名称
        /// </summary>
        private const string CsvFileName = "Buruman.csv";
        #endregion
        ...
        /// メンバ変数
        /// </summary>
        private static List<ClsBurumanCSV> m_Data = new List<ClsBurumanCSV>();
        #endregion
        ...
        public static bool GetCsv()
        {
            ...
            bool bHeader = true;
            List<ClsBurumanCSV> lstCls = new List<ClsBurumanCSV>();
            foreach (List<string> lstStr in lstlstStr)
            {
                ...
                ClsBurumanCSV cls = new ClsBurumanCSV();
                cls.Type = lstStr[0];
                cls.Size = lstStr[1];
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ClsBurumanCSV> GetCsvData()
        {
            GetCsv();
            return m_Data;
        }
