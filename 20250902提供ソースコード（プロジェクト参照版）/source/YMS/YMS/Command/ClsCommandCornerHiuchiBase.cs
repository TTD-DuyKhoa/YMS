...
namespace YMS.Command
{
    class ClsCommandCornerHiuchiBase
    {
        ...
        public static bool CommandChangeCornerHiuchiBase(UIDocument uidoc)
        {
            ...
            for (int i = 0; i < idList.Count(); i++)
            {
                ...
                else
                {
                    ...
                    //元データを取得
                    templateBase.m_Kousei = ClsRevitUtil.CompareValues(ClsRevitUtil.GetParameter(doc, id, "構成") == "シングル" ? ClsCornerHiuchiBase.Kousei.Single : ClsCornerHiuchiBase.Kousei.Double, templateBase.m_Kousei);
                    if (templateBase.m_Kousei == ClsCornerHiuchiBase.Kousei.Double)
                    {
                        templateBase.m_HiuchiLengthDoubleUpperL1 = ClsRevitUtil.CompareValues(ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "火打長さ(ダブル上)L1")), templateBase.m_HiuchiLengthDoubleUpperL1);
                        templateBase.m_HiuchiLengthDoubleUnderL2 = ClsRevitUtil.CompareValues(ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "火打長さ(ダブル下)L2")), templateBase.m_HiuchiLengthDoubleUnderL2);
                        templateBase.m_HiuchiZureryo = ClsRevitUtil.CompareValues(ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "上下火打ずれ量a")), templateBase.m_HiuchiZureryo);
                    }
                    else
                    {
                        templateBase.m_HiuchiLengthSingleL = ClsRevitUtil.CompareValues(ClsRevitUtil.CovertFromAPI(lCurve.Curve.Length), templateBase.m_HiuchiLengthSingleL);
                    }
                    ...
                    templateBase.m_TanbuParts1 = ClsRevitUtil.CompareValues(ClsRevitUtil.GetParameter(doc, id, "端部部品(1)"), templateBase.m_TanbuParts1);
                    templateBase.m_HiuchiUkePieceSize1 = ClsRevitUtil.CompareValues(ClsRevitUtil.GetParameter(doc, id, "火打受ピースサイズ(1)"), templateBase.m_HiuchiUkePieceSize1);
                    templateBase.m_TanbuParts2 = ClsRevitUtil.CompareValues(ClsRevitUtil.GetParameter(doc, id, "端部部品(2)"), templateBase.m_TanbuParts2);
                    templateBase.m_HiuchiUkePieceSize2 = ClsRevitUtil.CompareValues(ClsRevitUtil.GetParameter(doc, id, "火打受ピースサイズ(2)"), templateBase.m_HiuchiUkePieceSize2);
        ...
        public static ClsCornerHiuchiBase ChangeCornerHiuchiBase(UIDocument uidoc)
        {
            ...
            //元データを取得
            clsCHB.m_Kousei = ClsRevitUtil.GetParameter(doc, id, "構成") == "シングル" ? ClsCornerHiuchiBase.Kousei.Single : ClsCornerHiuchiBase.Kousei.Double;
            if (clsCHB.m_Kousei == ClsCornerHiuchiBase.Kousei.Double)
            {
                clsCHB.m_HiuchiLengthDoubleUpperL1 = ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "火打長さ(ダブル上)L1"));
                clsCHB.m_HiuchiLengthDoubleUnderL2 = ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "火打長さ(ダブル下)L2"));
                clsCHB.m_HiuchiZureryo = ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "上下火打ずれ量a"));
            }
            else
            {
                clsCHB.m_HiuchiLengthSingleL = ClsRevitUtil.CovertFromAPI(ClsRevitUtil.GetParameterDouble(doc, id, "火打長さ(シングル)L"));
            }
