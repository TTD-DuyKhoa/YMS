...
namespace YMS_gantry.UI
{
    public partial class FrmEditSizeList : System.Windows.Forms.Form
    {
        ...
        public FrmEditSizeList(ExternalEvent exEvent, RequestHandler handler, UIApplication uiApp, List<ElementId> targetElementIdList)
        {
            InitializeComponent();
        ...
        private void InitComponent()
        {
            foreach (var elementUniqueId in _targetElementUniqueIdList)
            {
                ...
                if (!existsBunrui)
                {
                    ...
                    if (((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_SUCHIFUNAJACK)
                        || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_PL && shouBunrui == CONST_SHOUBUNRUI_TAIKEIKOUPL)
                        || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_PL && shouBunrui == CONST_SHOUBUNRUI_SUCHIFUNAPL))
                    {
                ...
                if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_NEDA)
                {
                    buzaiCategory = CONST_CATEGORY_NEDA;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_SHUGETA)
                {
                    buzaiCategory = CONST_CATEGORY_SHUGETA;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_OHBIKI)
                {
                    buzaiCategory = CONST_CATEGORY_OHBIKI;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_KETAUKE)
                {
                    buzaiCategory = CONST_CATEGORY_KETAUKE;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_SHIKIGETA)
                {
                    buzaiCategory = CONST_CATEGORY_SHIKIGETA;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_JIFUKU)
                {
                    buzaiCategory = CONST_CATEGORY_JIFUKU;
                }
                else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_FUKKOUBANZUREDOMEZAI)
                {
                    buzaiCategory = CONST_CATEGORY_FUKKOUBANZUREDOMEZAI;
                }
                else if (((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_SOZAI)
                    || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_YAMADOME)
                    || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_KOUKYOUDOYAMADOME))
                {
                    buzaiCategory = CONST_CATEGORY_SHICHU;
                }
                else if (daiBunrui == CONST_DAIBUNRUI_YAMADOMEHEKI && chuuBunrui == CONST_CHUUBUNRUI_SHIJIKUI && shouBunrui == CONST_SHOUBUNRUI_KUI)
                {
        ...
        public void InitData()
        {
            ...
            {
                var rowIndex = this.DgvEditSizeList.Rows.Add(new object[] { rowData.Id, rowData.ElementId, false, rowData.KoudaiName, rowData.DaiBunrui, rowData.ChuuBunrui, rowData.ShouBunrui, rowData.BeforeSize, });
            ...
            {
                var rowIndex = this.DgvEditSizeCategoryList.Rows.Add(new object[] { false, rowData.KoudaiName, rowData.Category, });
        ...
        {
            var comboBoxCellOfAfterSize = (DataGridViewComboBoxCell)this.DgvEditSizeList.Rows[rowIndex].Cells["ColSizeListAfterSize"];
            ...
            var choicesSize = _choicesSizeList.FirstOrDefault(x => x.BunruiOfChoicesSize.Dai == daiBunrui && x.BunruiOfChoicesSize.Chuu == chuuBunrui && x.BunruiOfChoicesSize.Shou == shouBunrui);
            if (choicesSize  != null)
            {
            ...
            if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_FUKKOUBAN && shouBunrui == CONST_SHOUBUNRUI_FUKKOUBAN)
            {
                masterTypes = new List<string>() { Master.ClsFukkoubanCsv.TypeM,
                                          Master.ClsFukkoubanCsv.TypeNormal};

                comboBoxSizeList = CreateComboBoxFukkoubanSizeList(masterTypes);
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_OHBIKI)
            {
                masterTypes = new List<string>() { Master.ClsHBeamCsv.TypeHiro,
            ...
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_NEDA)
            {
                masterTypes = new List<string>() { Master.ClsHBeamCsv.TypeHiro,
                                          Master.ClsHBeamCsv.TypeNaka,
                                          Master.ClsHBeamCsv.TypeHoso,
            ...
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_FUKKOUGETA)
            {
                masterTypes = new List<string>() { Master.ClsFukkouGetaCsv.TypeH,
                                          Master.ClsFukkouGetaCsv.TypeC,
                                          Master.ClsFukkouGetaCsv.TypeYamadome};

                comboBoxSizeList = CreateComboBoxFukkouGetaSizeList(masterTypes);
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_TAIKEIKOU)
            {
                comboBoxSizeList = CreateComboBoxTaikeikouSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_SLOPEMAZUMEZAI)
            {
                comboBoxSizeList = CreateComboBoxSlopeMazumezaiSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_FUKKOUBANZUREDOMEZAI)
            {
            ...
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_SUCHIFUNAJACK)
            {
                comboBoxSizeList = CreateComboBoxSuchifunaJackSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_TORITSUKEHOJYOZAI)
            {
                comboBoxSizeList = CreateComboBoxToritsukehojyozaiSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_PL && shouBunrui == CONST_SHOUBUNRUI_TAIKEIKOUPL)
            {
                comboBoxSizeList = CreateComboBoxTaikeikouPLSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_PL && shouBunrui == CONST_SHOUBUNRUI_SUCHIFUNAPL)
            {
                comboBoxSizeList = CreateComboBoxSuchifunaPLSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_TAKASACHOUSEIPIEACE)
            {
                comboBoxSizeList = CreateComboBoxTakasaChouseiPieaceSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_TAKASACHOUSEIPIEACE && shouBunrui == CONST_SHOUBUNRUI_KAKOUHIN)
            {
                comboBoxSizeList = CreateComboBoxTakasaChouseiPieaceHBeamSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_PL && shouBunrui == CONST_SHOUBUNRUI_TAKASACHOUSEIPL)
            {
                comboBoxSizeList = CreateComboBoxTakasaChouseiPLSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_FUKKOUBAN && shouBunrui == CONST_SHOUBUNRUI_SHIMAKOUBAN)
            {
                comboBoxSizeList = CreateComboBoxShimaKoubanSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_FUKKOUBAN && shouBunrui == CONST_SHOUBUNRUI_SHIKITEPPAN)
            {
            ...
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_TESURI)
            {
                comboBoxSizeList = CreateComboBoxTesuriSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_TESURISHICHU)
            {
                comboBoxSizeList = CreateComboBoxTesuriShichuSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_BRACE)
            {
                comboBoxSizeList = CreateComboBoxBraceSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_BRACE && shouBunrui == CONST_SHOUBUNRUI_TURNBUCKLEBRACE)
            {
                comboBoxSizeList = CreateComboBoxTurnBuckleBraceSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_TEIKETSUKANAGU && shouBunrui == CONST_SHOUBUNRUI_BULMAN)
            {
                comboBoxSizeList = CreateComboBoxBulmanSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_TEIKETSUKANAGU && shouBunrui == CONST_SHOUBUNRUI_RIKIMAN)
            {
                comboBoxSizeList = CreateComboBoxRikimanSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_TSUNAGI)
            {
                comboBoxSizeList = CreateComboBoxTsunagiSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_HOUDUE)
            {
                comboBoxSizeList = CreateComboBoxHouzueYamadomeSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_HIUCHIUKE)
            {
                comboBoxSizeList = CreateComboBoxHouzueHiuchiUkeSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_HOUDUE)
            {
                comboBoxSizeList = CreateComboBoxHouzueSozaiSizeList();
            }
            else if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SUMIBUPIEACE)
            {
                comboBoxSizeList = CreateComboBoxHouzueSumibuPieaceSizeList();
            }
            else if (daiBunrui == CONST_DAIBUNRUI_KOUDAIKUI && chuuBunrui == CONST_CHUUBUNRUI_TSUGITASHIKUI && shouBunrui == CONST_SHOUBUNRUI_TSUGITASHIKUI)
            {
                comboBoxSizeList = CreateComboBoxTsugitashiKuiSizeList();
            }
            if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_SOZAI)
            {
                comboBoxSizeList = CreateComboBoxShichuSozaiSizeList();
            }
            if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_YAMADOME)
            {
                comboBoxSizeList = CreateComboBoxShichuYamadomeSizeList();
            }
            if ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_KOUKYOUDOYAMADOME)
            {
                comboBoxSizeList = CreateComboBoxShichuKoukyoudoYamadomeSizeList();
            }
            if (daiBunrui == CONST_DAIBUNRUI_YAMADOMEHEKI && chuuBunrui == CONST_CHUUBUNRUI_SHIJIKUI && shouBunrui == CONST_SHOUBUNRUI_KUI)
            {
                masterTypes = new List<string>() { Master.ClsHBeamCsv.TypeHiro,
                                          Master.ClsHBeamCsv.TypeNaka,
                                          Master.ClsHBeamCsv.TypeHoso };
            ...
            choicesSize = new ChoicesSize { BunruiOfChoicesSize = new Bunrui { Dai = daiBunrui, Chuu = chuuBunrui, Shou = shouBunrui }, ValueOfChoicesSize = comboBoxSizeList };
            _choicesSizeList.Add(choicesSize);
        }

        private void CreateComboBoxSizeListOfCategory(int rowIndex)
        {
            var comboBoxCellOfAfterSize = (DataGridViewComboBoxCell)this.DgvEditSizeCategoryList.Rows[rowIndex].Cells["ColSizeCategoryListAfterSize"];
            var category = this.DgvEditSizeCategoryList.Rows[rowIndex].Cells["ColSizeCategoryListCategory"].Value.ToString();
            ...
            {
                comboBoxSizeList = CreateComboBoxShichuSozaiSizeList();
                comboBoxSizeList.AddRange(CreateComboBoxShichuYamadomeSizeList().Where(x => !string.IsNullOrEmpty(x)).ToList());
                comboBoxSizeList.AddRange(CreateComboBoxShichuKoukyoudoYamadomeSizeList().Where(x => !string.IsNullOrEmpty(x)).ToList()) ;
            }
            ...
            // 一度作成したカテゴリのサイズ選択肢を保存
            choicesSizeCategory = new ChoicesSizeOfCategory { CategoryOfChoicesSize = category, ValueOfChoicesSize = comboBoxSizeList };
        ...
        private List<string> CreateComboBoxKetazaiSizeList(List<string> masterTypes)
        {
            ...
            foreach (var masterType in masterTypes)
            {
                if (masterType == Master.ClsYamadomeCsv.TypeShuzai ||
                    masterType == Master.ClsYamadomeCsv.TypeHighShuzai) //主材
                {
                    lstStr.AddRange(Master.ClsYamadomeCsv.GetSizeList(masterType));
                }
                else if (masterType == Master.ClsHBeamCsv.TypeHoso ||
                    masterType == Master.ClsHBeamCsv.TypeNaka ||
        ...
        private List<string> CreateComboBoxSlopeMazumezaiSizeList()
        {
            List<string> lstStr = new List<string>();
            lstStr.Add(string.Empty);
            lstStr.AddRange(Master.ClsMasterCsv.Shared.Where(x => !string.IsNullOrEmpty(x.MadumeSymbol)).Select(x => x.Size).ToList());
        ...
        private List<string> CreateComboBoxZuredomeSizeList(bool isTypeC = true)
        {
            ...
            if (isTypeC)
            {
                lstStr.AddRange(Master.ClsJifukuZuredomeCsv.GetSizeList(Master.ClsJifukuZuredomeCsv.TypeZuredomezai, Master.ClsJifukuZuredomeCsv.TypeC));
                return lstStr;
            }

            lstStr.AddRange(Master.ClsJifukuZuredomeCsv.GetSizeList(Master.ClsJifukuZuredomeCsv.TypeZuredomezai, Master.ClsJifukuZuredomeCsv.TypeL));
        ...
        private List<string> CreateComboBoxJifukuSizeList()
        {
            List<string> lstStr = new List<string>();
            lstStr.Add(string.Empty);
            lstStr.AddRange(Master.ClsJifukuZuredomeCsv.GetSizeList(Master.ClsJifukuZuredomeCsv.TypeJifuku, Master.ClsJifukuZuredomeCsv.TypeC));
        ...
        private List<RowDataOfSizeList> CreateRowDataOfSizeList(List<string> elementUniqueIds)
        {
            ...
            foreach (var elementUniqueId in elementUniqueIds)
            {
                ...
                var rowData = new RowDataOfSizeList { Id = id, ElementId = elemId, KoudaiName = koudaiName, DaiBunrui = daiBunrui, ChuuBunrui = chuuBunrui, ShouBunrui = shouBunrui, BeforeSize = familyName, };
        ...
        private void DgvEditSizeCategoryList_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (_targetElementUniqueIdList.Count() != 0)
            {
                ...
                // 選択されたRowより種別列の値を取得
                var selectedCategoryList = selectedRowList.Select(x => new CategoryRow() { KoudaiName = x.Cells["ColSizeCategoryListKoudai"].Value.ToString(), Category = x.Cells["ColSizeCategoryListCategory"].Value.ToString() });
                ...
                foreach (var categoryRow in selectedCategoryList)
                {
                    foreach (var elementUniqueId in _targetElementUniqueIdList)
                    {
                        ...
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_NEDA)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_SHUGETA)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_SHUGETA)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_OHBIKI)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_OHBIKI)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_KETAUKE)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_KETAUKE)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_SHIKIGETA)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_SHIKIGETA)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_JIFUKU)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_KETAZAI && shouBunrui == CONST_SHOUBUNRUI_JIFUKU)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_FUKKOUBANZUREDOMEZAI)
                        {
                            if (!((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SONOTA && shouBunrui == CONST_SHOUBUNRUI_FUKKOUBANZUREDOMEZAI)) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_SHICHU)
                        {
                            if (!(((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_SOZAI)
                            || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_YAMADOME)
                            || ((daiBunrui == CONST_DAIBUNRUI_KOUDAI_1 || daiBunrui == CONST_DAIBUNRUI_KOUDAI_2) && chuuBunrui == CONST_CHUUBUNRUI_SHUZAI && shouBunrui == CONST_SHOUBUNRUI_SHICHU_KOUKYOUDOYAMADOME))) continue;
                        }
                        else if (categoryRow.Category == CONST_CATEGORY_SHIJIKUI)
                        {
                            if (!(daiBunrui == CONST_DAIBUNRUI_YAMADOMEHEKI && chuuBunrui == CONST_CHUUBUNRUI_SHIJIKUI && shouBunrui == CONST_SHOUBUNRUI_KUI)) continue;
                        }
                        else
                        {
                            continue;
        ...
        private void DgvEditSizeList_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var cellEditingCheck = this.DgvEditSizeList.Rows[e.RowIndex].Cells["ColSizeListSelected"] as DataGridViewCheckBoxCell;
            ...
            for (var i = 0; i < this.DgvEditSizeList.RowCount; i++)
            {
                ...
                {
                    var cellEditSize = this.DgvEditSizeList.Rows[i].Cells["ColSizeListAfterSize"] as DataGridViewComboBoxCell;
        ...
        private void DgvEditSizeCategoryList_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var cellEditingCheck = this.DgvEditSizeCategoryList.Rows[e.RowIndex].Cells["ColSizeCategoryListSelected"] as DataGridViewCheckBoxCell;
            // 選択中セルのチェック状態が有効でない場合は処理スキップ
            if (!(bool)cellEditingCheck.Value) return;
            ...
            {
                var cellCheck = this.DgvEditSizeCategoryList.Rows[i].Cells["ColSizeCategoryListSelected"] as DataGridViewCheckBoxCell;

                // 編集中のセルを除くかつ、チェックが有効な場合
                if ((cellEditing.RowIndex != cellCheck.RowIndex) && (bool)cellCheck.Value)
                {
                    var cellEditSize = this.DgvEditSizeCategoryList.Rows[i].Cells["ColSizeCategoryListAfterSize"] as DataGridViewComboBoxCell;
                    var cellEditingSize = cellEditing as DataGridViewComboBoxCell;
