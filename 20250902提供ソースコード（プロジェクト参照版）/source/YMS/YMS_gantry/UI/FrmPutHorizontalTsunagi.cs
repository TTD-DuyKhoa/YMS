...
namespace YMS_gantry.UI
{
    public partial class FrmPutHorizontalTsunagi : Form
    {
        ...
        private void InitializeBindings()
        {
            ...
            CmbKoudaiName.DataBindings.Add(nameof(System.Windows.Forms.ComboBox.DataSource), vm, nameof(VMType.KodaiSet), true, DataSourceUpdateMode.OnPropertyChanged);
            CmbKoudaiName.DisplayMember = nameof(AllKoudaiFlatFrmData.KoudaiName);
            CmbKoudaiName.DataBindings.Add(nameof(System.Windows.Forms.ComboBox.SelectedValue), vm, nameof(VMType.SelectedKodai), true, DataSourceUpdateMode.OnPropertyChanged);

            CmbSize.DataBindings.Add(nameof(System.Windows.Forms.ComboBox.DataSource), vm, nameof(VMType.HrzJointSizeList), true, DataSourceUpdateMode.OnPropertyChanged);
            CmbSize.DisplayMember = nameof(ClsChannelCsv.Size);
            CmbSize.DataBindings.Add(nameof(System.Windows.Forms.ComboBox.SelectedValue), vm, nameof(VMType.HrzJointSize), true, DataSourceUpdateMode.OnPropertyChanged);

            RbtPutWayMulti.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.PlaceIsMultiple), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtPutWaySingle.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.PlaceIsSingle), true, DataSourceUpdateMode.OnPropertyChanged);

            NmcSLng.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzJointStartMm), true, DataSourceUpdateMode.OnPropertyChanged);
            NmcELng.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.HrzJointEndMm), true, DataSourceUpdateMode.OnPropertyChanged);

            RbtAttachWayWelding.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsWelding), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtAttachWayBolt.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsBolt), true, DataSourceUpdateMode.OnPropertyChanged);
            RbtAttachWayTeiketsu.DataBindings.Add(nameof(RadioButton.Checked), vm, nameof(VMType.HrzJointIsMetal), true, DataSourceUpdateMode.OnPropertyChanged);

            NmcDanCount.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.DanCount), true, DataSourceUpdateMode.OnPropertyChanged);
            NmcDanSpan.DataBindings.Add(nameof(YmsNumericInteger.DoubleValue), vm, nameof(VMType.DanBaseInterval), true, DataSourceUpdateMode.OnPropertyChanged);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (koudaiData == null || koudaiData.BraceTsunagiData == null || koudaiData.BraceTsunagiData.HorizontalTsunagi == null || koudaiData.BraceTsunagiData.DanSetting == null)
            {
