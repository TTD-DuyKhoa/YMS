...
{
    class ClsFukkouGetaCsv : ClsMasterCsv
    {
        #region メンバ変数
        /// <summary>
        /// CSV名称
        /// </summary>
        private const string CsvFileName = "FukkouGeta.csv";

        /// <summary>
        /// メンバ変数
        /// </summary>
        private static List<ClsFukkouGetaCsv> m_Data = new List<ClsFukkouGetaCsv>();
        ...
        public static bool GetCsv()
        {
            ...
            bool bHeader = true;
            List<ClsFukkouGetaCsv> lstCls = new List<ClsFukkouGetaCsv>();
            foreach (List<string> lstStr in lstlstStr)
            {
                ...
                ClsFukkouGetaCsv cls = new ClsFukkouGetaCsv();
                cls.Type = lstStr[0];
                cls.Size = lstStr[1];
        ...
        /// <returns></returns>
        [YmsMasterLoad]
        public static List<ClsFukkouGetaCsv> GetCsvData()
        {
            GetCsv();
            return m_Data;
        }
