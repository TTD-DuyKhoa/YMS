...
{
    class ClsKoubanzaiCsv : ClsMasterCsv
    {
        #region メンバ変数
        /// <summary>
        /// CSV名称
        /// </summary>
        private const string CsvFileName = "Koubanzai.csv";

        /// <summary>
        /// メンバ変数
        /// </summary>
        private static List<ClsKoubanzaiCsv>  m_Data = new List<ClsKoubanzaiCsv>();
        ...
        /// 種類
        /// </summary>
        public const string TypeShimaKouban = "縞鋼板";
        public const string TypeShikiteppan = "敷鉄板";

        /// <summary>
        /// 種類
        /// </summary>
        public static List<string> Thickness = new List<string>() { "PL19", "PL22", "PL25" };
        #endregion
        ...
        public static bool GetCsv()
        {
            ...
            bool bHeader = true;
            List<ClsKoubanzaiCsv> lstCls = new List<ClsKoubanzaiCsv>();
            foreach(List<string> lstStr in lstlstStr)
            {
                ...
                ClsKoubanzaiCsv cls = new ClsKoubanzaiCsv();
                cls.Type = lstStr[0];
                cls.Size = lstStr[1];
        ...
        /// <returns></returns>
        [YmsMasterLoad]
        public static List<ClsKoubanzaiCsv> GetCsvData()
        {
            GetCsv();
            return m_Data;
        }
