...
namespace YMS_gantry
{
    ...
    public sealed class Ohbiki : OhbikiSuper
    {
        ...
        public Ohbiki(ElementId id, string koudaname, OhbikiData data, int k = int.MinValue) : base(id, koudaname, data,k)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<ElementId> CreateOhbiki(Document doc, OhbikiData data, XYZ start, XYZ end, Level level, bool isDoboku,string koudainame, double leveloffset = 0, double rotate = 0,FamilySymbol oriSym= null,bool reverse = false)
        {
